...
streamlit run dashboard_v112.py
CHANGELOG (v112):
...
- STAGE 19 (v111): Resolved SQLite 'database is locked' deadlock in the Accountability Journal by enforcing per-iteration commits and increasing timeout resiliency.
- STAGE 18 (v110): Built the Alpha Accountability Journal. Implemented the 'Campaign' tracking concept, snapshot freezing (SMAs/Sector/Industry), and the R-Multiple Discipline Grading System.
=============================================================================
"""
...
if not df_open.empty:
    # THE CFO TAG DICTIONARY (You can easily edit this list right here in the script at any time)
    tag_opts = ["13F", "VCP", "ALCC", "Q-EP", "20SMA", "50SMA", "200SMA", "M-FLOW", "ATR Ext"]
    
    st.markdown(f"<div style='font-size: 13px; color: #475569; margin-bottom: 12px; background-color: #f8fafc; padding: 10px; border-radius: 6px; border: 1px solid #cbd5e1;'><b>📚 CFO Tag Dictionary:</b> <code>{', '.join(tag_opts)}</code><br><i>(Type your tags into the cell below separated by commas. You can also invent new ones on the fly!)</i></div>", unsafe_allow_html=True)
