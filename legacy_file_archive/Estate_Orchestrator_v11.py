r"""
=============================================================================
Script Name: Estate_Orchestrator_v11.py
File Path: C:\Users\donca\Desktop\Desktop HP Envy x360 al 22Abr24\Docs Manuel\IBKR_Options\Estate_Orchestrator_v11.py
...
def get_col(df, possible_names):
    """ v11 CHANGE: Resilient column finder to prevent KeyErrors """
...
def process_ibkr_data(sections):
    # ---------------------------------------------------------
    # 1. Update Daily NAV (v11 FIX: .agg instead of .sum)
    # ---------------------------------------------------------
    ...
    if nav_df is not None:
        ...
        # v11 CHANGE: Used .agg('last', 'sum') to prevent duplicate line explosions!
    ...
    # ---------------------------------------------------------
    # 2. Extract Live Allocations & Opt Margin (v11 CHANGE)
    # ---------------------------------------------------------
    live_pos = {
        ...
        for _, row in pos_df.iterrows():
            ...
            if silo == 'D':
                ...
                if 'IB01' in sym: live_pos[silo]['IB01'] += usd_val
                    ...
                    # v11 CHANGE: Automate Opt Margin based on negative quantity
                    if qty < 0:
...
if __name__ == "__main__":
    print("========================================================")
    print("     ESTATE ORCHESTRATOR v11 - INITIALIZING SYNC...      ")
    print("========================================================")
    ...
    os.system('python Generate_Estate_Dashboard_v59.py')
    
    html_path = os.path.join(TARGET_DIR, "Family_Estate_Dashboard_v59.html")
