...
3. Launch the UI by running exactly:
   streamlit run dashboard_v51.py
...
def get_exact_opt_margin(df_in):
    # v51: Exclude both Tail Hedges and Synthetic Beta (Long Calls) from margin liability math
...
def load_champion_history():
    ...
    conn.commit()
    # v51: Fetching 'rowid' as primary key to allow precise editing later in the ledger
...
# v51: Synthetic Beta Rolling Radar
if not pos_df.empty:
