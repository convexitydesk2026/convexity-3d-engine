"""
=============================================================================
Script Name: Telegram_Notifier_v36.py
...
def snap_and_send():
    ...
    # v36 FIX: Pointed to dashboard_pro_v182.py
    streamlit_process = subprocess.Popen(["streamlit", "run", "dashboard_pro_v182.py", "--server.port", "8599", "--server.headless", "true"], cwd=TARGET_DIR, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    time.sleep(12)
