r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v23.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 23 UPGRADES: 
         - BUG FIX: Patched the "KeyError: Estate_Cum" crash from v22.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v23.html")
...
if not bench_df.empty and not global_df.empty:
    ...
    if first_date:
        ...
        # V23 BUG FIX: Ensure the master daily return is renamed correctly for the loop below
...
<head>
    ...
    <title>Family Estate Master Allocator v23</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v23</p>
        </div>
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v23 created.")
