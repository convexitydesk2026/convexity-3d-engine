...
streamlit run dashboard_v110.py
CHANGELOG (v110):
...
- STAGE 17 (v109): Permanently silenced Streamlit deprecation warnings by injecting Market Flow HTML as a pure markdown iframe. Pointed execution button to v4 to fix CSS transparency bugs.
- STAGE 16 (v108): Pointed Market Flow Engine to v3. The matrix is now globally unified and pre-sorted by 1-Month Momentum. Added Volume Climax indicator (🔥) and Sticky Headers.
=============================================================================
"""
...
conn_journal = sqlite3.connect(DB_PATH)
...
if not df_open.empty:
    tag_opts = ["", "13F", "VCP", "ALCC", "Q-EP", "20SMA", "50SMA", "200SMA", "M-FLOW"]
    ...
    edited_open = st.data_editor(
        ...
        column_config={
            ...
            "tags": st.column_config.SelectboxColumn("Tag", options=tag_opts, required=False),
