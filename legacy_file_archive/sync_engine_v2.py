...
def sync_tws():
    print("========================================================")
    print("     ESTATE SYNC ENGINE v2 - LIVE TWS CONNECTION")
    print("========================================================")
    ...
    # 3. OPEN THE DATA FAUCETS
    print("[*] Waking up TWS data streams (this takes 2 seconds)...")
    for acc in accounts:
        ib.reqAccountUpdates(True, acc)
    
    # Give TWS a moment to push the portfolio data over the local network
    ib.sleep(2)
    ...
    # 6. Close Faucets, Commit and Clean Up
    for acc in accounts:
        ib.reqAccountUpdates(False, acc)
