r"""
=============================================================================
Script Name: Estate_Notifier_v2.py
...
# Pointing to the latest v67 HTML Dashboard
html_file = f"file:///{os.path.join(target_directory, 'Family_Estate_Dashboard_v67.html').replace(chr(92), '/')}"
