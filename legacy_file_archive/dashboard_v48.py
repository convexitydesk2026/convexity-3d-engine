...
3. Launch the UI by running exactly:
   streamlit run dashboard_v48.py

CHANGELOG (v48):
         - ADDED: Sector Concentration Pie Chart (via Automated yfinance SQLite caching).
         - ADDED: 3D Topography support for "Synthetic Beta" (Deep ITM Long Calls).
=============================================================================
"""
...
def load_champion_history():
    ...
    conn.commit()
    # v48: Fetching 'rowid' as primary key to allow precise editing later in the ledger
