...
3. Launch the UI by running exactly:
   streamlit run dashboard_v77.py

CHANGELOG (v77):
         - FIXED: Replaced LEFT JOIN with OUTER JOIN for Cash Flows to fix dropped dates.
         - FIXED: Replaced LEFT JOIN with OUTER JOIN for Attribution to fix MTM mismatches.
=============================================================================
"""
    ...
    if not global_df.empty:
        ...
        try:
            ...
            if not temp_attr.empty:
                ...
                # V77 FIX: OUTER JOIN to prevent dropping official PnL on days TWS wasn't synced
