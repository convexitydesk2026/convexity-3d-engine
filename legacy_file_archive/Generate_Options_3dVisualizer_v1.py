r"""
=============================================================================
Script Name: Generate_Options_3dVisualizer_v1.py
Purpose: Generates a unified, interactive HTML dashboard combining both 
         ...
         Includes real-time Greeks calculation and educational footer.
Author: Chief Investment Officer AI Advisor
Date: April 2026

How to Run:
1. Ensure Python is installed on your PC.
2. Save this script as 'Generate_Options_3dVisualizer_v1.py'.
3. Run it via terminal or your Python IDE:
   python Generate_Options_3dVisualizer_v1.py
4. Navigate to your folder and open 'Master_Options_Dashboard.html'.
...
file_name = "Master_Options_Dashboard.html"
...
<head>
    ...
    <title>Family Office Master Options Dashboard</title>
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Master Options Dashboard created.")
