...
streamlit run dashboard_v106.py
CHANGELOG (v106):
...
with st.expander("📊 Expand Institutional Flow Dashboard", expanded=False):
    ...
    if os.path.exists(html_path):
        ...
        # Reverted to components.html to enforce iframe CSS sandboxing.
        # Do NOT use st.html() here, or the report's global CSS will leak and ruin the dashboard's tables.
