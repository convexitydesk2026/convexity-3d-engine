...
Launch the UI by running exactly: streamlit run market_flow_engine_v9.py             
Author:      Virtual CFO
Date:        August 2026
Version:     9.0 (Added Playwright Viewport Cropping & Markdown Text Extraction)
================================================================================
"""
...
def get_insight_html():
    ...
    md_text = "🚨 **Top Actionable Discoveries** 🚨\n\n"
