"""
=============================================================================
Script Name: attribution_engine_v17.py
Purpose: Parses the official IBKR Flex Query (MTM and CNAV).
         - NEW: Full API Automation via Flex Web Service.
         - NEW: "Time Machine" Database Healer (Backfills missing NAVs).
...
def run_attribution():
    print("========================================================")
    print("   ESTATE P&L ATTRIBUTION ENGINE (v17 FULL AUTOMATION)")
    ...
    print("[+] SUCCESS: v17 Engine Complete. Full Automation & Healing Deployed.\n")
