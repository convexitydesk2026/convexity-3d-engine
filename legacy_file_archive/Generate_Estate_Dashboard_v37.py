r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v37.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 33 UPGRADES:
         - Fixed CSS overflow in the "Target Portfolio Composition" panel.
         - Removed conflicting flex-height constraints and added proper spacing 
           (mb-2) to the sliders to eliminate crowding.
         - Restored the upper-left Explanatory Box, Legend, and exact layout 
           for the Monte Carlo Simulation chart.
         - Preserved all v32 restorations (Metrics, transparent backgrounds, 
           SPY/QQQ overlays, and full Matrix details).
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v37.html")
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v37)            ")
print("========================================================")
...
<head>
    ...
    <title>Estate Master Dashboard v37</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v37</p>
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <!-- SILO INPUTS -->
                <div class="bg-gray-50 p-4 rounded-xl border shadow-sm flex-grow">
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-white p-4 rounded-xl border shadow-sm flex-grow">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                        ...
                        <!-- Silo A -->
                        <div class="bg-blue-50 p-4 rounded-lg border border-blue-400 shadow-inner">
                            <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-blue-400 pb-1">Silo A</h4>
                            <p class="text-[10px] font-bold text-gray-800 mb-1 uppercase tracking-wide">Physical Balance Sheet</p>
                            <label class="text-[10px] font-bold text-gray-900" id="a_ib01_label">IB01: </label><input type="range" id="a_ib01" min="0" max="100" step="0.01" value="100.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_cspx_label">CSPX: </label><input type="range" id="a_cspx" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_cndx_label">CNDX: </label><input type="range" id="a_cndx" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_itwn_label">ITWN (Taiwan): </label><input type="range" id="a_itwn" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_cskr_label">CSKR (Korea): </label><input type="range" id="a_cskr" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_cnya_label">CNYA (China): </label><input type="range" id="a_cnya" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_crypto_label">Crypto ETPs: </label><input type="range" id="a_crypto" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_cash_label">Cash: </label><input type="range" id="a_cash" min="-50" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-red-600" id="a_opt_mkt_label">Opt. Mkt Val (Liability): </label><input type="range" id="a_opt_mkt" min="-20" max="0" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            ...
                            <label class="text-[10px] font-bold text-green-700" id="a_xsp_label">Options Margin: </label><input type="range" id="a_xsp" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                        </div>

                        <!-- Silo B -->
                        <div class="bg-purple-50 p-4 rounded-lg border border-purple-400 shadow-inner">
                            <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-purple-400 pb-1">Silo B</h4>
                            <p class="text-[10px] font-bold text-gray-800 mb-1 uppercase tracking-wide">Physical Balance Sheet</p>
                            <label class="text-[10px] font-bold text-gray-900" id="b_ib01_label">IB01: </label><input type="range" id="b_ib01" min="0" max="100" step="0.01" value="41.15" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_cash_label">Cash: </label><input type="range" id="b_cash" min="-50" max="100" step="0.01" value="58.85" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_cfd_label">US Tech CFDs: </label><input type="range" id="b_cfd" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_intl_label">Intl Stocks: </label><input type="range" id="b_intl" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_itwn_label">ITWN (Taiwan): </label><input type="range" id="b_itwn" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_cskr_label">CSKR (Korea): </label><input type="range" id="b_cskr" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_cnya_label">CNYA (China): </label><input type="range" id="b_cnya" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <p class="text-[10px] text-red-600 font-bold mt-1 h-4" id="b_warning"></p>
                        </div>

                        <!-- Silo C -->
                        <div class="bg-green-50 p-4 rounded-lg border border-green-400 shadow-inner">
                            <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-green-400 pb-1">Silo C</h4>
                            <p class="text-[10px] font-bold text-gray-800 mb-1 uppercase tracking-wide">Physical Balance Sheet</p>
                            <label class="text-[10px] font-bold text-gray-900" id="c_ib01_label">IB01: </label><input type="range" id="c_ib01" min="0" max="100" step="0.01" value="100.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_cspx_label">CSPX: </label><input type="range" id="c_cspx" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_cndx_label">CNDX: </label><input type="range" id="c_cndx" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_itwn_label">ITWN (Taiwan): </label><input type="range" id="c_itwn" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_cskr_label">CSKR (Korea): </label><input type="range" id="c_cskr" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_cnya_label">CNYA (China): </label><input type="range" id="c_cnya" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_crypto_label">Crypto ETPs: </label><input type="range" id="c_crypto" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_cash_label">Cash: </label><input type="range" id="c_cash" min="-50" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-red-600" id="c_opt_mkt_label">Opt. Mkt Val (Liability): </label><input type="range" id="c_opt_mkt" min="-20" max="0" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            ...
                            <label class="text-[10px] font-bold text-green-700" id="c_xsp_label">Options Margin: </label><input type="range" id="c_xsp" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                        </div>

                        <!-- Silo D -->
                        <div class="bg-yellow-50 p-4 rounded-lg border border-yellow-400 shadow-inner">
                            <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-yellow-400 pb-1">Silo D</h4>
                            <p class="text-[10px] font-bold text-gray-800 mb-1 uppercase tracking-wide">Physical Balance Sheet</p>
                            <label class="text-[10px] font-bold text-gray-900" id="d_ib01_label">IB01: </label><input type="range" id="d_ib01" min="0" max="100" step="0.01" value="40.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_cspx_label">CSPX: </label><input type="range" id="d_cspx" min="0" max="100" step="0.01" value="30.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_cndx_label">CNDX: </label><input type="range" id="d_cndx" min="0" max="100" step="0.01" value="15.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_itwn_label">ITWN (Taiwan): </label><input type="range" id="d_itwn" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_cskr_label">CSKR (Korea): </label><input type="range" id="d_cskr" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_cnya_label">CNYA (China): </label><input type="range" id="d_cnya" min="0" max="100" step="0.01" value="0.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_crypto_label">Crypto ETPs: </label><input type="range" id="d_crypto" min="0" max="100" step="0.01" value="5.0" class="w-full mb-2" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_cash_label">Cash: </label><input type="range" id="d_cash" min="-50" max="100" step="0.01" value="10.0" class="w-full mb-2" oninput="updateUI()">
    ...
    <script>
        ...
        function updateUI() {
            ...
            // Restore the percentage calculations
            ...
            let barLayout = { 
                ...
                margin: {b: 40, t: 80}, // Increased top margin to fit the labels
        ...
        if (benchDates && benchDates.length > 0) {
            ...
            // Restored SPY and QQQ overlays for the 4 Silo Charts
        ...
        if (datesPnl && datesPnl.length > 0) {
            ...
            let pnlLayout = {
                ...
                paper_bgcolor: 'rgba(0,0,0,0)',
                plot_bgcolor: 'rgba(0,0,0,0)',
                // Ensure fixedrange is false for X so we can scroll-zoom horizontally
                xaxis: { type: 'date', showgrid: false, fixedrange: false },
                // Set fixedrange: true for Y axes so mouse wheel ONLY zooms horizontally, triggering our vertical auto-adjust script
                yaxis: { title: 'Daily PnL (USD)', side: 'left', showgrid: true, gridcolor: '#e5e7eb', zeroline: true, zerolinecolor: '#9ca3af', zerolinewidth: 2, fixedrange: true },
                yaxis2: { title: 'Cumulative PnL (USD)', side: 'right', overlaying: 'y', showgrid: false, zeroline: false, fixedrange: true },
                legend: { orientation: 'h', y: 1.1, x: 0.5, xanchor: 'center' }
            };
            
            let pnlConfig = {displayModeBar: false, responsive: true, scrollZoom: true};
            Plotly.react('daily-pnl-chart',[traceA, traceB, traceC, traceD, traceEstateLine, traceSPYLine, traceQQQLine], pnlLayout, pnlConfig);

            // Dynamic Vertical Auto-Scaling based on Horizontal Zoom
            ...
            pnlPlot.on('plotly_relayout', function(eventdata) {
                if (eventdata['xaxis.range[0]'] || eventdata['xaxis.range[1]']) {
                    ...
                    // Find local min/max for stacked bars (Y1 Axis)
                    ...
                    // Find local min/max for cumulative lines (Y2 Axis)
                    ...
                    // Execute auto-scaling safely to avoid infinite loops
                    if (Object.keys(update).length > 0) {
                        Plotly.relayout(pnlPlot, update);
                    }
                } else if (eventdata['xaxis.autorange']) {
                    // Reset Y axes if the user double-clicks to reset the chart
        ...
        if (mcOrig && mcOrig.length > 0) {
            ...
            // Restored Random Colors and 50% Thicker Spaghetti (width: 1.5)
            ...
            // 50% Thicker Primary Lines (width: 4.5)
            ...
            let mcLayout = {
                ...
                // The '0' axis remains strictly untouched at zerolinewidth: 2
...
# Re-injected Monte Carlo variables
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v37 created.")
