...
3. Launch the UI by running exactly:
   streamlit run dashboard_v83.py

CHANGELOG (v83):
         - BUG FIX: Explicitly defined hardcoded anchors for all subheaders to fix Streamlit React router dead-link bug.
=============================================================================
"""
...
def process_metrics(df_acc, rf_rate):
    ...
    # v83 Absolute Truth Math: Start NAV is inherently 0
...
def load_and_process_data():
    ...
    try:
        ...
        # v83 FIX: Robust NAV Forward Fill (Solves the Phantom Volatility Jump)
    ...
    # Global tracking arrays (v83: Pure Absolute Math across all Silos. Kills the Whipsaw)
