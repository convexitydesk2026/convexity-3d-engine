r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v61.py
Purpose: Generates the Interactive Family Estate Dashboard.
         ...
         - Hardcoded filename output to v61.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v61.html") # v61 CHANGE
...
def process_metrics(df_acc):
    ...
    # --- v61 FIX: Eliminate the "Dead Air" penalty for Volatility Metrics ---
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v61)            ") # v61 CHANGE
print("========================================================")
...
if not bench_df.empty and not global_df.empty:
    ...
    if first_date:
        ...
        # --- v61 ALIGNMENT LOGIC: Find the exact day actual trading started ---
...
<head>
    ...
    <title>Estate Master Dashboard v61</title> <!-- v61 CHANGE -->
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8 relative">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v61</p>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <!-- ========================================================= -->
            <!-- PANEL 6: DEPLOYMENT & CAPACITY TRACKER (v61 UPGRADE)      -->
            <!-- ========================================================= -->
            <div class="xl:col-span-12 mt-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div class="bg-gray-50 border border-gray-200 rounded-lg p-4 relative overflow-hidden flex flex-col justify-between">
                            <div>
                                ...
                                <!-- v61 DYNAMIC DEPLOYMENT SCHEDULE -->
    ...
    <script>
        ...
        function updateUI() {
            ...
            // =========================================================
            // PANEL 6 LOGIC (Deployment Tracker - v61 UPGRADE)
            // =========================================================
            ...
            // v61: Dynamic Tranche Calculator & Date Generator
            ...
            // v61 PnL Attribution Donut Plot (Zero-Sum Fix)
        ...
        if (Object.keys(liveAlloc).length > 0) {
            ...
            if (liveAlloc['A']) {
                ...
                document.getElementById('a_xsp').value = liveAlloc['A']['OPT_MARGIN'] || 0; // v61 CHANGE
            }
            ...
            if (liveAlloc['C']) {
                ...
                document.getElementById('c_xsp').value = liveAlloc['C']['OPT_MARGIN'] || 0; // v61 CHANGE
            }
        }
...
# --- v61 CAPITAL VELOCITY INJECTION ---
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v61 created.")
