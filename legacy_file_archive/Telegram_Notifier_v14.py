"""
=============================================================================
Script Name: Telegram_Notifier_v14.py
Purpose: Headless Streamlit rendering and Telegram transmission.
         - Updated to target dashboard_v67.py
         - Retains dynamic scroll loop to render lazy-loaded components.
=============================================================================
"""
...
def snap_and_send():
    ...
    # v14 Update: Pointing to dashboard_v67.py
    streamlit_process = subprocess.Popen(["streamlit", "run", "dashboard_v67.py", "--server.port", "8599", "--server.headless", "true"],
        cwd=TARGET_DIR,
