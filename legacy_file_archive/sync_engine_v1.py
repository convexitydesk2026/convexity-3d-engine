...
def sync_tws():
    print("========================================================")
    print("     ESTATE SYNC ENGINE v1 - LIVE TWS CONNECTION")
    print("========================================================")
    ...
    # 2. Connect to Database & Clear Today's Previous Runs (UPSERT logic)
    conn = init_db()
    cursor = conn.cursor()
    ...
    for acc in accounts:
        # We request account values and filter for Base Currency Net Liq and Cash
