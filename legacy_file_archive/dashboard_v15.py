"""
=============================================================================
Script Name: dashboard_v15.py
Purpose: The Streamlit Frontend (Module 15 - Stabilization).
         - Fixed infinite refresh loop by normalizing dataframes before comparison.
         - Cleared Streamlit/Pandas 2026 FutureWarnings (applymap -> map, width='stretch').
         - Preserved exact clearinghouse option margin math and matrix checksums.
=============================================================================
"""
...
st.markdown(f"**Script version:** `dashboard_v15.py`")
st.divider()
...
if not journal_raw_df.empty:
    ...
    # 5. Database Auto-Save Engine (Normalized to Kill Infinite Loop)
    ...
    if not normalize_for_compare(journal_raw_df).equals(normalize_for_compare(edited_df)):
        conn = sqlite3.connect(DB_PATH)
