r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v48.py
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v48.html") # v48 CHANGE: Name updated
...
if not bench_df.empty and not global_df.empty:
    ...
    if first_date:
        ...
        # v48 CHANGE: Calculate Comprehensive Benchmark Metrics (Alpha, Corr, Sharpe for SPY & QQQ)
...
<head>
    ...
    <title>Estate Master Dashboard v48</title> <!-- v48 CHANGE -->
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v48</p> <!-- v48 CHANGE -->
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-gray-100 p-4 rounded-xl shadow-md border border-gray-300 relative">
                    ...
                    <!-- v48 CHANGE: Expanded grid to md:grid-cols-7 (14 items total) to neatly fit SPY/QQQ Sharpes, Alphas, and Corrs -->
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-white p-4 rounded-xl border shadow-sm">
                    ...
                    <!-- v48 CHANGE: Silo Strategy & Execution Guidelines -->
    ...
    <script>
        ...
        function updateUI() {
            ...
            // v48 CHANGE: Calculate True Net Checksum by explicitly showing the Liability Drag
...
# v48 CHANGE: Calculate Alpha, Correlation, and Benchmark Sharpes
spy_alpha_str = "N/A"
spy_corr_str = "N/A"
qqq_alpha_str = "N/A"
qqq_corr_str = "N/A"
...
# v48 CHANGE: Inject into HTML using exact variable mapping
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v48 created.")
