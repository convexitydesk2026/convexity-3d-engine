r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v64.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 62 UPGRADES:
         - Zero-Sum Fallback for Donut Chart.
         - X-Axis "Dead Air" Cropping dynamically frames historical plots.
=============================================================================
"""
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v64.html")
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v64)            ")
print("========================================================")
...
<head>
    ...
    <title>Estate Master Dashboard v64</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8 relative">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v64</p>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div class="xl:col-span-12 mt-2 grid grid-cols-1 xl:grid-cols-12 gap-4">
                ...
                <div class="xl:col-span-4 bg-white border rounded-xl p-4 shadow-sm flex flex-col">
                    ...
                    <!-- NEW v64: PnL Legend / Footer Updates -->
                    <div class="mb-4 text-[10px] text-gray-600 leading-tight bg-gray-50 p-2 rounded border border-gray-200">
                        <span class="text-blue-500 font-bold">Risk-Free Yield:</span> T-Bill Interest (IB01/Cash).<br>
                        <span class="text-orange-500 font-bold">Core Beta:</span> Long-term physical equities (CSPX/CNDX).<br>
                        <span class="text-green-500 font-bold">VRP Engine:</span> Options premium (Silos A & C XSP/XND Puts).<br>
                        <span class="text-purple-500 font-bold">Active Alpha:</span> Swing/Momentum plays (Silos B & D).
                    </div>
                    
                    <!-- Capital Velocity Widget -->
                    <div class="flex-grow flex flex-col justify-end">
                        <h4 class="text-xs font-black text-gray-500 uppercase tracking-widest mb-3">Options Engine (Silos A & C) Velocity</h4>                        
    ...
    <script>
        ...
        function updateUI() {
            ...
            // v64 PnL Attribution Donut Plot (Zero-Sum Fix)
        ...
        if (datesPnl && datesPnl.length > 0) {
            ...
            // v64: Find first active trading day to crop "dead air"
            let firstIdx = 0;
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v64 created.")
