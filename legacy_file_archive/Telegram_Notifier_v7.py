...
"""
=============================================================================
Script Name: Telegram_Notifier_v7.py
Purpose: Headless Streamlit rendering and Telegram transmission.
         - Updated to target dashboard_v38.py.
...
def snap_and_send():
    ...
    # UPDATED to dashboard_v38.py
    streamlit_process = subprocess.Popen(["streamlit", "run", "dashboard_v38.py", "--server.port", "8599", "--server.headless", "true"],
        cwd=TARGET_DIR,
