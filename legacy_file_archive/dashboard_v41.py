...
3. Launch the UI by running exactly:
   streamlit run dashboard_v41.py

CHANGELOG (v41):
         - NEW: Panel 10: Champion Journal & TOR Ledger.
         - NEW: Algorithmic 1R Lock-in and dynamic Stop-Loss mapping.
         - NEW: Executive Briefing alerts for Ideal TOR breaches.
=============================================================================
"""
