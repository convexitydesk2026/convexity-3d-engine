...
3. Launch the UI by running exactly:
   streamlit run dashboard_v75.py

CHANGELOG (v75):
         - FIXED: Suppressed Pandas downcasting warning.
...
def load_and_process_data():
    ...
    try:
        ...
        # v75: Suppress Pandas future warning by explicitly avoiding silent downcasting
