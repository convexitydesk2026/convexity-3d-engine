r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v16.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 16 UPGRADES: 
         - Added Time-Weighted Return (TWR) benchmark chart (Estate vs SPY vs QQQ).
         - Mathematically strips cash flows from the Estate line for an apples-to-apples comparison.
         - Perfectly formatted UI blending the new chart into the gray master panel.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v16.html")
...
if os.path.exists(csv_file_path):
    try:
        ...
        # Calculate strict daily returns for global_df needed for benchmark chart
...
if not bench_df.empty and not global_df.empty:
    ...
    if not merged_df.empty:
        ...
        # Ensure all lines start the race exactly at 0% on the first overlapping date
...
<head>
    ...
    <title>Family Estate Master Allocator v16</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[1800px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v16</p>
        </div>
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v16 created.")
