r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v65.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 65 UPGRADES:
         - Replaced PnL Donut Chart with a USD-denominated Bar Chart.
         - Added Cumulative PnL Line Chart for a1-a5 tracking.
         - Implemented Non-Intrusive Progressive Exposure Advisory Widgets.
=============================================================================
"""
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v65.html")
...
# Process Daily PnL Attribution for v65 Charts
...
<head>
    ...
    <title>Estate Master Dashboard v65</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8 relative">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v65</p>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <!-- SECTION 4: MONTE CARLO & PNL ATTRIBUTION (v65 Upgrades) -->
            <div class="xl:col-span-12 mt-2 grid grid-cols-1 xl:grid-cols-12 gap-4">
                ...
                <div class="xl:col-span-6 bg-white border rounded-xl p-4 shadow-sm flex flex-col">
                    ...
                    <!-- v65: Replaced Donut Chart with Bar and Line Grid -->
                    ...
                    <!-- Capital Velocity Widget (v65 Text Correction) -->
    ...
    <script>
        ...
        function updateUI() {
            ...
            // v65 Progressive Exposure Advisor Inject
            ...
            // -------------------------------------------------------------
            // v65: USD-Denominated PnL Bar Chart & Cumulative Trajectory
            // -------------------------------------------------------------
...
# --- v65 PROGRESSIVE EXPOSURE ADVISORY INJECTION ---
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v65 created.")
