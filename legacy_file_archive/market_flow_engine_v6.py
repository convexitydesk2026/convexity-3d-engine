...
Launch the UI by running exactly: streamlit run market_flow_engine_v6.py             
Author:      Virtual CFO
Date:        July 2026
Version:     6.0 (Moved Actionable Discoveries to Header for BLUF executive summary)
================================================================================
"""
