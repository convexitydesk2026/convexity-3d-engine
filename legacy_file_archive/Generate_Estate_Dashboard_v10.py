r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v10.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 10: 
         - FULLY RESTORED 'Master Instrument Matrix' missing from V9.
         - Fixed Max Drawdown math bug (now uses Cumulative Returns to 
           ignore cash withdrawals/deposits instead of raw NAV).
         - Fixed Silo D contrast (Light yellow background, dark fonts).
...
full_file_path = os.path.join(target_directory, "Generate_Estate_Dashboard_v10.html") # We will name the HTML v10 as well to keep it clean
...
def process_account_metrics(df, account_id):
    ...
    # --- Max Drawdown (Fixed: Using Cumulative Returns Index to ignore withdrawals) ---
...
# ---------------------------------------------------------
# 4. Define HTML Payload (Includes Fully Restored Matrix)
# ---------------------------------------------------------
...
<head>
    ...
    <title>Family Estate Master Allocator v10</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[1800px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v10</p>
        </div>
        ...
        <div class="mb-8 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <!-- Silo D: Fixed Legibility (Light Yellow bg, Dark text) -->
            <div class="bg-yellow-100 text-gray-900 p-4 rounded-xl shadow-md text-center border-b-4 border-yellow-400">
                <h4 class="text-sm text-yellow-800 uppercase tracking-widest font-bold">Silo D (Vault 2)</h4>
                <p class="text-xs mb-1 text-gray-600">U25218481</p>
...
# Silo D uses light theme, pass "light" to get_color_class if needed, or rely on hardcoded classes in HTML
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v10 created.")
