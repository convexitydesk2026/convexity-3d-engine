...
3. Launch the UI by running exactly:
   streamlit run dashboard_v49.py

CHANGELOG (v49):
         - ADDED: "Rolling Radar" automated DTE alerts for Synthetic Beta.
         - UPDATED: Categorization logic to isolate Long Calls from Options Margin math.
=============================================================================
"""
...
def get_exact_opt_margin(df_in):
    # v49: Exclude both Tail Hedges and Synthetic Beta (Long Calls) from margin liability math
...
def load_champion_history():
    ...
    conn.commit()
    # v49: Fetching 'rowid' as primary key to allow precise editing later in the ledger
...
# v49: Synthetic Beta Rolling Radar
if not pos_df.empty:
