r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v52.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 52 UPGRADES:
         - Engineered to receive the new automated 'OPT_MARGIN' data from the 
           v9 Orchestrator.
         - Preserved all v51 features (Reconciliation trackers, PTJ Rules, 
           Tail-Risk guidelines, Absolute Dollar Inputs).
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v52.html") # v52 CHANGE
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v52)            ") # v52 CHANGE
print("========================================================")
...
<head>
    ...
    <title>Estate Master Dashboard v52</title> <!-- v52 CHANGE -->
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v52</p> <!-- v52 CHANGE -->
        </div>
    ...
    <script>
        ...
        if (Object.keys(liveAlloc).length > 0) {
            ...
            if (liveAlloc['A']) {
                ...
                document.getElementById('a_xsp').value = liveAlloc['A']['OPT_MARGIN'] || 0; // v52 CHANGE
            }
            ...
            if (liveAlloc['C']) {
                ...
                document.getElementById('c_xsp').value = liveAlloc['C']['OPT_MARGIN'] || 0; // v52 CHANGE
            }
        }
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v52 created.")
