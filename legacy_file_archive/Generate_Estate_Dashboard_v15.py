r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v15.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 15 UPGRADES: 
         - BUG FIX: Restored JavaScript DOM innerText updates for all slider labels 
           (CSPX, XUSE, EIMI, Cash, CFDs) which were omitted in v14.
         - Retains all advanced metrics (Global Estate, True ROC%, Calmar).
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v15.html")
...
<head>
    ...
    <title>Family Estate Master Allocator v15</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[1800px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v15</p>
        </div>
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v15 created.")
