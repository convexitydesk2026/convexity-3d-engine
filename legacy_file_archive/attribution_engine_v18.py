"""
=============================================================================
Script Name: attribution_engine_v18.py
Purpose: Parses the official IBKR Flex Query (MTM and CNAV).
         - FIXED: Python datetime import error.
         - MAINTAINED: Full API Automation via Flex Web Service.
         - MAINTAINED: "Time Machine" Database Healer.
=============================================================================
"""
...
def run_attribution():
    print("========================================================")
    print("   ESTATE P&L ATTRIBUTION ENGINE (v18 FULL AUTOMATION)")
    ...
    with open(FLEX_CSV_PATH, 'r', encoding='utf-8-sig') as f:
        ...
        for row in reader:
            ...
            if row_type == 'HEADER':
                if sec_type == 'CNAV': 
                    cnav_idx = {val: i for i, val in enumerate(row)}
                elif sec_type == 'MTMP': 
                    mtmp_idx = {val: i for i, val in enumerate(row)}
    ...
    print("[+] SUCCESS: v18 Engine Complete. Full Automation & Healing Deployed.\n")
