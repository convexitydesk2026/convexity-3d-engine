"""
=============================================================================
Script Name: dashboard_pro_v183.py
...
(Alternatively, open a terminal in this directory and run: streamlit run dashboard_pro_v183.py)

CHANGELOG (v183 PRO):
- STAGE 91 (v183 PRO): Predictive Margin Shock Simulator (TIMS) integrated into S.W.A.N.
- STAGE 90 (v182 PRO): Automated Publisher Export Pipeline ("1-Click Publish") integrated.
...
with st.sidebar:
    ...
    - [101. Publisher Export Pipeline](#sec101)
    """)
    st.markdown("---")
