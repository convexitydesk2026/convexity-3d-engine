...
3. Launch the UI by running exactly:
   streamlit run dashboard_v86.py
...
def process_metrics(df_acc, rf_rate):
    ...
    # v86 Absolute Truth Math: Start NAV is inherently 0
...
def load_and_process_data():
    ...
    try:
        ...
        # v86 FIX: Robust NAV Forward Fill (Solves the Phantom Volatility Jump)
    ...
    # Global tracking arrays (v86: Pure Absolute Math across all Silos. Kills the Whipsaw)
