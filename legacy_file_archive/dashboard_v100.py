...
streamlit run dashboard_v100.py
CHANGELOG (v100):
- STAGE 8 (v100): Integrated standalone Market Flow Engine (market_flow_report.html) as a collapsible hybrid component.
- STAGE 8 (v100): Added sidebar trigger to run market_flow_engine_v1.py directly from the UI.
- STAGE 7f (v91d): Option A implemented. Synthetic Beta and Tail Hedges now definitively classified via SQLite Options Journal cross-reference instead of fragile DTE heuristics.
- STAGE 7e (v91d): Reconciled T-0 Live vs T-1 Flex Query attribution lag.
=============================================================================
"""
