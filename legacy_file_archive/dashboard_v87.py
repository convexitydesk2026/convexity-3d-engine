...
3. Launch the UI by running exactly:
   streamlit run dashboard_v87.py
...
def process_metrics(df_acc, rf_rate):
    ...
    # v87 Absolute Truth Math: Start NAV is inherently 0
...
def load_and_process_data():
    ...
    try:
        ...
        # v87 FIX: Robust NAV Forward Fill (Solves the Phantom Volatility Jump)
    ...
    # Global tracking arrays (v87: Pure Absolute Math across all Silos. Kills the Whipsaw)
