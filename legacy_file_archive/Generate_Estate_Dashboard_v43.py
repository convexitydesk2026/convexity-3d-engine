r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v43.py
Purpose: Generates the Interactive Family Estate Dashboard.
         ...
         - All modifications tagged with 'v43 CHANGE'.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v43.html") # v43 CHANGE: Name updated
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v43)            ") # v43 CHANGE
print("========================================================")
...
<head>
    ...
    <title>Estate Master Dashboard v43</title> <!-- v43 CHANGE -->
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v43</p> <!-- v43 CHANGE -->
        </div>
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-gray-50 p-4 rounded-xl border shadow-sm">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <!-- v43 CHANGE: Silo D returned to manual edit populated by CSV to match unified approach -->
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-white p-4 rounded-xl border shadow-sm">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                        ...
                        <!-- Silo A -->
                        <!-- v43 CHANGE: Converted A to 1/2 width absolute dollar input boxes -->
                        ...
                        <!-- Silo B -->
                        <!-- v43 CHANGE: Converted B to 1/2 width absolute dollar input boxes -->
                        ...
                        <!-- Silo C -->
                        <!-- v43 CHANGE: Converted C to 1/2 width absolute dollar input boxes -->
                        ...
                        <!-- Silo D -->
                        <!-- v43 CHANGE: Modified D to perfectly match 1/2 width layout of A,B,C -->
    ...
    <script>
        ...
        function updateUI() {
            // v43 CHANGE: Silos A, B, C, D in Panel 1 are ALL pulled from manual input, preserving CSV default
            ...
            // Silo A
            // v43 CHANGE: Pulled direct dollar values from typed inputs
            ...
            // v43 CHANGE: Dynamically update the readonly text boxes to show percentage
            ...
            // Silo D
            // v43 CHANGE: Re-aligned D to match the new reconciliation logic of A, B, C
            let amt_D_cfd = 0;
            for(let i=1; i<=10; i++) {
            ...
            // v43 CHANGE: Update the readonly Cash label with percentage
...
for acc, prefix in[("ESTATE", "ESTATE"), ("U23144948", "A"), ("U23139264", "B"), ("U23154199", "C"), ("U25218481", "D")]:
    ...
    if prefix != "ESTATE":
        # v43 CHANGE: Replaces VAR_NAV_* with exact values for inputs
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v43 created.")
