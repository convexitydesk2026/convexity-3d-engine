...
with c_gb_marg:
    ...
    fig_gauge_margin.update_layout(
        height=250, margin=dict(l=10, r=10, t=40, b=20),
        annotations=[dict(x=0.5, y=0.05, text="⚠️ 18% Warning | 🚨 20% FINRA Limit", showarrow=False, font=dict(size=12, color="#991b1b", weight="bold"))]
    )
...
# 2. Equity & Synthetic Beta Losses
