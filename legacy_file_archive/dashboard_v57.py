...
3. Launch the UI by running exactly:
   streamlit run dashboard_v57.py

CHANGELOG (v57):
         - DECOMMISSIONED: Obsolete TOR capacity breach alerts.
         - PATCHED: Suppressed Naked Option alarms for directional macro shorts (SMH).
         - PATCHED: Cleaned up duplicate process_champion_journal functions.
=============================================================================
"""
...
# We load the dataframe for UI rendering, but TOR alerts are formally decommissioned.
...
if not journal_raw_df.empty:
    ...
    if selected_rows.empty:
        ...
        if str(raw_dte) == 'Closed':
            ...
            # v57: 3D Engine Native Debit Spread Detection
