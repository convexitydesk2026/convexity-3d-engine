r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v28.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 28 UPGRADES (Synthesis of v27a & v27b): 
         - Added 'Contingent' CSS class and matrix rows for /MES and CTAs.
         - Fixed Plotly touch-screen shadow menu bug (displayModeBar: 'hover').
         - Small silo charts hide modebar entirely for maximum cleanliness.
         - Retains safeParse() JSON injection to prevent browser syntax crashes.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v28.html")
...
# 3.d Benchmark Parsing & Integration (Theoretical Replicator)
...
if not bench_df.empty and not global_df.empty:
    ...
    if first_date:
        ...
        # Safely extract all arrays to JS strings
...
<head>
    ...
    <title>Family Estate Master Allocator v28</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v28</p>
        </div>
    ...
    <script>
        ...
        const instruments =[
            ...
            { inst: "/MES Put Spreads", type: "Futures Option", risk: "Moderate", alpha: "Highest (SPAN)", sharpe: "High", strat: "Capital Efficiency", jur: "US (CME)", min: "0%", max: "25%", rec: "Contingent", class: "contingent", comm: "Contingent on mastering XSP mechanics. SPAN margin halves collateral, doubling ROC." },
            { inst: "Managed Futures (CTAs)", type: "UCITS Fund", risk: "Moderate", alpha: "Crisis Alpha", sharpe: "High (Uncorrelated)", strat: "Trend Following", jur: "Ireland", min: "0%", max: "15%", rec: "Contingent", class: "contingent", comm: "Contingent on risk tolerance change. Shorts commodities & bonds to protect during crashes." },
        ...
        function updateUI() {
            ...
            Plotly.react('bar-chart', barData, barLayout, {responsive: true, displayModeBar: 'hover'});
            ...
            Plotly.react('pie-chart', pieData, pieLayout, {responsive: true, displayModeBar: 'hover'});
            ...
            if (benchDates && benchDates.length > 0) {
                ...
                Plotly.react('benchmark-chart',[traceEstate, traceSPY, traceQQQ], benchLayout, {responsive: true, displayModeBar: 'hover'});
            ...
            if (datesPnl && datesPnl.length > 0) {
                ...
                Plotly.react('daily-pnl-chart',[traceA, traceB, traceC, traceD, traceEstateLine, traceSPYLine, traceQQQLine], pnlLayout, {responsive: true, displayModeBar: 'hover'});
            }
        }
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v28 created.")
