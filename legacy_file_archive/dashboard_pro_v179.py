"""
=============================================================================
Script Name: dashboard_pro_v179.py
...
(Alternatively, open a terminal in this directory and run: streamlit run dashboard_pro_v179.py)

CHANGELOG (v179 PRO):
- STAGE 87 (v179 PRO): Integrated estate_env.py for dynamic OS-agnostic pathing.
...
SYNC_SCRIPT = os.path.join(TARGET_DIR, "sync_engine_v38.py")
