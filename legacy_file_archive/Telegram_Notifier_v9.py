"""
=============================================================================
Script Name: Telegram_Notifier_v10.py
Purpose: Headless Streamlit rendering and Telegram transmission.
         - Updated to target dashboard_v45.py
=============================================================================
"""
...
def snap_and_send():
    ...
    streamlit_process = subprocess.Popen(["streamlit", "run", "dashboard_v45.py", "--server.port", "8599", "--server.headless", "true"],
        cwd=TARGET_DIR,
