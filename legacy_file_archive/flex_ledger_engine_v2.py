"""
=============================================================================
Script Name: flex_ledger_engine_v2.py
Purpose: Automated Historical Trade Ingestion via IBKR Flex Query API.
         - v2 FIX: Defeated the ASCII Date Trap by explicitly formatting YYYYMMDD to YYYY-MM-DD.
         - Pulls XML Executions, calculates R-Metrics, and syncs the Champion Journal.
         - Features "Local File Fallback" if the API is unreachable.
=============================================================================
"""
import sqlite3
import pandas as pd
...
def run_flex_sync():
    print("========================================================")
    print("   ESTATE FLEX QUERY ENGINE v1 - CHAMPION JOURNAL SYNC")
    print("========================================================")
    ...
    print(f"[+] Flex Sync Complete! {inserts} new trades ingested. ({duplicates} historical trades skipped).")
