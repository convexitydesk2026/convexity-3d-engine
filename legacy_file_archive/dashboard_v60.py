...
3. Launch the UI by running exactly:
   streamlit run dashboard_v60.py

CHANGELOG (v60):
         - PATCHED: "The Decapitation Bug". Categorizer now enforces Broad Market Whitelist for Tail Hedges.
         - PATCHED: Replaced hardcoded Naked Option alerts with Context-Aware Guardrails.
         - UPGRADED: Partitioned Topography Engine into 4 specific Barbell Radar Screens.
=============================================================================
"""
                ...
                try:
                    ...
                    if len(parts) >= 4:
                        ...
                        if right == 'P' and dte > 60:
                            # v60: Broad Market Whitelist prevents Decapitation Bug for Sector Shorts (like SMH)
...
if not journal_raw_df.empty:
    ...
    if not active_vrp.empty:
        ...
        # v60: Dynamically map LIVE TWS PnL to calculate Live Annualized ROC
        live_roc_list = []
        live_ann_roc_list = []
...
if not journal_raw_df.empty:
    ...
    if selected_rows.empty:
        ...
        if str(raw_dte) == 'Closed':
            ...
            # v60: 3D Engine Native Debit Spread & Call Detection
