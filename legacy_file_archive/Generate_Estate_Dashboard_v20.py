r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v20.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 20 UPGRADES: 
         - PIVOT: Removed XUSE and EIMI entirely.
         - Added CNDX (Nasdaq 100 UCITS) for High-Beta US Tech exposure.
         - BUG FIX: Cash sliders now allow negative values (down to -50%) 
           to accommodate temporary margin loans and balance GAAP math perfectly.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v20.html")
...
<head>
    ...
    <title>Family Estate Master Allocator v20</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v20</p>
        </div>
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v20 created.")
