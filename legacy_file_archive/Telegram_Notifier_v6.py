"""
=============================================================================
Script Name: Telegram_Notifier_v6.py
Purpose: Headless Streamlit rendering and Telegram transmission.
         - Updated to target dashboard_v19.py.
         - Canvas expanded to 8500px to accommodate new Executive Briefings.
         - Render wait time extended to 40s for Monte Carlo & yFinance loads.
=============================================================================
"""
...
def snap_and_send():
    ...
    # UPDATED to dashboard_v19.py
    streamlit_process = subprocess.Popen(["streamlit", "run", "dashboard_v19.py", "--server.port", "8599", "--server.headless", "true"],
        cwd=TARGET_DIR,
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            # EXPANDED starting canvas to 8500px to account for the larger v19 layout
