...
Launch the UI by running exactly: streamlit run market_flow_engine_v5.py             
Author:      Virtual CFO
Date:        July 2026
Version:     5.0 (GICS & Thematic Sector Expansion + Dynamic Lookback Failsafe)
================================================================================
"""
