...
3. Launch the UI by running exactly:
   streamlit run dashboard_v45.py

CHANGELOG (v45):
         - FIX: Populated Net Credit auto-calculation in Options Ledger.
         - UI OVERHAUL: Compacted Options Ledger (font reduction, hid non-critical columns, aggressive abbreviation, stripped decimal fat).
=============================================================================
"""
