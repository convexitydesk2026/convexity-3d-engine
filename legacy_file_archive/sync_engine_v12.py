...
def sync_tws():
    print("========================================================")
    print("   ESTATE SYNC ENGINE v12 - ISOLATED SESSION EXTRACTION")
    print("========================================================")
