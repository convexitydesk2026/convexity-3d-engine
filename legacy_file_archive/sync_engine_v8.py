"""
=============================================================================
Script Name: sync_engine_v8.py
Purpose: Phase 1 of the Local-First Estate Architecture.
         Bulletproof Balance Extraction (BASE vs USD) & API Cooldowns.
=============================================================================
"""
...
def sync_tws():
    print("========================================================")
    print("     ESTATE SYNC ENGINE v8 - PRISTINE DATA SYNC")
    print("========================================================")
    ...
    for acc in accounts:
        ...
        print("[*] Opening data stream (waiting 4 seconds for complete packet delivery)...")
        ...
        # 4. CRITICAL COOL-DOWN: Extended to 2.5s to ensure TWS drops the previous subscription
        ib.sleep(2.5)

        # 5. Process Balances (Strict BASE protection)
        net_liq_base = None
        ...
        # Use BASE if it exists, otherwise fallback to USD
