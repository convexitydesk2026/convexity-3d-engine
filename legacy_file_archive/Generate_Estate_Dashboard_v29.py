r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v29.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 29 UPGRADES: 
         - Disabled Plotly ModeBars permanently for clean UI.
         - Unified Silo colors (Header = Mini-Chart = Sliders = Histogram).
         - Thickened Estate & Silo lines by 50%; Enhanced horizontal gridlines.
         - Added 'Tax Treatment' column and sorted 'Splendid' matrix rows.
         - Changed QQQ to Red; Renamed to Estate Master Dashboard.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v29.html")
...
if not bench_df.empty and not global_df.empty:
    ...
    if first_date:
        ...
        print("[OK] Array Serialization: 0 NaN/Inf syntax errors detected.")
    else:
...
<head>
    ...
    <title>Estate Master Dashboard v29</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v29</p>
        </div>
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-white p-4 rounded-xl border shadow-sm flex-grow">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                        ...
                        <!-- Silo A -->
                        <div class="bg-blue-300 p-3 rounded-lg border border-blue-400 shadow-inner">
                        ...
                        <!-- Silo B -->
                        <div class="bg-purple-300 p-3 rounded-lg border border-purple-400 shadow-inner">
                        ...
                        <!-- Silo C -->
                        <div class="bg-green-300 p-3 rounded-lg border border-green-400 shadow-inner">
                        ...
                        <!-- Silo D -->
                        <div class="bg-yellow-300 p-3 rounded-lg border border-yellow-400 shadow-inner">
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v29 created.")
