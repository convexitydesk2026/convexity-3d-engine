r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v27a.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 27 UPGRADES: 
         - BULLETPROOF FIX: Implemented safeParse() and string shielding to 
           completely eradicate JavaScript Syntax Errors caused by NaN/Infinity.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v27a.html")
...
if os.path.exists(csv_file_path):
    try:
        ...
        # 3.c Calculate Daily PnL Histogram Data
...
if not bench_df.empty and not global_df.empty:
    ...
    if first_date:
        ...
        # Forward fill weekends for smooth plotting
        ...
        # JSON String Serialization for Browser Shielding
...
<head>
    ...
    <title>Family Estate Master Allocator v27a</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v27a</p>
        </div>
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v27a created.")
