"""
=============================================================================
Script Name: dashboard_v12.py
Purpose: The Streamlit Frontend (Module 12 - Final Polish).
         - Adds script version string to the main header.
         - Phase 4 Canceled: Options Engine Velocity panel overhauled.
         - Replaced hardcoded placeholders with live VRP Harvested & Margin Locked metrics.
         - Preserves all v11 zero-axis standardizations, matrix checksums, and MC logic.
=============================================================================
"""
...
st.markdown(f"**Script version:** `dashboard_v12.py`")
st.divider()
...
if not attr_df.empty:
    ...
    with col_vel:
        ...
        # Calculate dynamic locked margin
