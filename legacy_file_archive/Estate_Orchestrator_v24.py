r"""
=============================================================================
Script Name: Estate_Orchestrator_v24.py
Purpose: The Zero-Touch Automation Engine for the Family Office.
         v24 UPGRADES & CURES:
         - SELF-HEALING PROTOCOL: Automatically wipes corrupted Local DBs if 
           a new Estate_Master_Feed.csv is detected, forcing a pristine rebuild.
         - AGGRESSIVE SCRUBBING: Applies strict `.strip()` to all CSV values 
           during parsing to guarantee deduplication math never fails ($80M bloat fix).
=============================================================================
"""
...
# -------------------------------------------------------------------
# EXPLICIT FLEX QUERY PARSER (WITH AGGRESSIVE SCRUBBING)
# -------------------------------------------------------------------
def parse_ibkr_flex(csv_text):
    ...
    for row in reader:
        ...
        if r_type == 'HEADER':
            ...
            if sec in headers:
                # AGGRESSIVE SCRUBBING: Strip spaces from all values to ensure deduplication
...
if __name__ == "__main__":
    print("========================================================")
    print("     ESTATE ORCHESTRATOR v24 - INITIALIZING SYNC...      ")
    print("========================================================")
    create_backup()    
