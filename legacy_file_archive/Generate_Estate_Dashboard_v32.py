r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v32.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 32 UPGRADES (The Uncompromised Edition):
         - 100% restoration of v30 UI (transparent backgrounds, SPY/QQQ silo 
           overlays, full 7-metric diagnostics per silo).
         - Restored Matrix columns (Strategy, Comments).
         - Removed Target Composition scrollbars; implemented bottom-aligned 
           flex-grow matching with Estate Capital.
         - Integrates v31 Features: Foreign ETFs, Risk Radars, Total Checksum, 
           and the Silo B Progressive Exposure Tier Tracker.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v32.html")
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v32)            ")
print("========================================================")
...
<head>
    ...
    <title>Estate Master Dashboard v32</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v32</p>
        </div>
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-white p-4 rounded-xl border shadow-sm flex-grow">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4 h-full">
                        ...
                        <!-- Silo A -->
                        <div class="bg-blue-50 p-3 rounded-lg border border-blue-400 shadow-inner flex flex-col">
                            ...
                            <label class="text-[10px] font-bold text-red-600" id="a_opt_mkt_label">Opt. Mkt Val (Liability): </label><input type="range" id="a_opt_mkt" min="-20" max="0" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            ...
                            <label class="text-[10px] font-bold text-green-700" id="a_xsp_label">Options Margin: </label><input type="range" id="a_xsp" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                        </div>

                        <!-- Silo B -->
                        <div class="bg-purple-50 p-3 rounded-lg border border-purple-400 shadow-inner flex flex-col">
                        ...
                        <!-- Silo C -->
                        <div class="bg-green-50 p-3 rounded-lg border border-green-400 shadow-inner flex flex-col">
                            ...
                            <label class="text-[10px] font-bold text-red-600" id="c_opt_mkt_label">Opt. Mkt Val (Liability): </label><input type="range" id="c_opt_mkt" min="-20" max="0" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            ...
                            <label class="text-[10px] font-bold text-green-700" id="c_xsp_label">Options Margin: </label><input type="range" id="c_xsp" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                        </div>

                        <!-- Silo D -->
                        <div class="bg-yellow-50 p-3 rounded-lg border border-yellow-400 shadow-inner flex flex-col">
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v32 (Fully Restored & Uncompromised) created.")
