"""
=============================================================================
Script Name: sync_engine_v30.py
Purpose: Phase 8 of the Local-First Estate Architecture.
         - RESTORED: PEP-8 Formatting.
         - UPDATED: Added Zero-Balance Failsafe to prevent False Drawdowns.
=============================================================================
"""
...
def sync_tws():
    print("========================================================")
    print("   ESTATE SYNC ENGINE v30 - DRAWDOWN FAILSAFE")
    print("========================================================")    
    ...
    for acc in accounts:        
        ...
        # --- THE DRAWDOWN FAILSAFE ---
        if net_liq_usd < 100.0:
            print(f"[!] FAILSAFE TRIGGERED: {acc} returned ${net_liq_usd}. Likely API timeout. Skipping DB insert to prevent false drawdowns.")
    ...
    # --- THE HISTORICAL LOOPHOLE FIX: ALPHA WATCHLIST IV SCANNER ---
        ...
        try:
            ...
            for row in watchlist:
                ...
                try:
                    ...
                    # Instead of a live stream (which IBKR blocks without subs),
                    # we request the historical Option Implied Volatility EOD bar.
                    ...
                    if bars and len(bars) > 0:
                        # IBKR returns the IV as a decimal (e.g. 1.065 for 106.5%)
