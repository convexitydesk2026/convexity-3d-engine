...
if not df_alpha.empty:
    ...
    fig_alpha.update_layout(
        ...
        margin=dict(l=20, r=20, t=65, b=20), height=480,
        legend=dict(orientation="h", yanchor="bottom", y=1.02, xanchor="right", x=1)
    )
    ...
    display_alpha = df_alpha[['Ticker', 'Shares', 'Spot Price', 'Market Value', 'Cost', 'Avg SL', 'Open Risk', 'Locked Profit', 'Unlocked Profit', 'Total Profit']].copy()
    ...
    st.dataframe(display_alpha.style.format({
        ...
        'Cost': '${:,.0f}', 'Avg SL': '${:,.2f}', 'Open Risk': '${:,.0f}', 
        'Locked Profit': '${:,.0f}', 'Unlocked Profit': '${:,.0f}', 'Total Profit': '${:,.0f}'
