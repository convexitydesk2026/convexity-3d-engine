"""
=============================================================================
Script Name: dashboard_v30.py
Purpose: The Streamlit Frontend (Family Office Estate Architecture)
         - Deployment Command Center: Implemented Proportional Silo Routing.
           Automatically splits the Weekly Shopping list between Silo A and 
           Silo C based on their live relative Net Asset Values (NAVs).
         - Button Ledger remains active to prevent EOD double-spending.
         ...
         - SGLN/IGLN (Physical Gold) explicitly tracked as 5% Alternative.
=============================================================================
"""
...
with c_action:
    if distance_usd <= 1000:
        ...
        # Calculate Proportional Weights for Silo A and Silo C
        ...
        cspx_tot = actual_deploy * 0.50
        cndx_tot = actual_deploy * 0.25
        asia_tot = actual_deploy * 0.15
        cryp_tot = actual_deploy * 0.05
        gold_tot = actual_deploy * 0.05

        # Render the Target-Weighted Matrix with HTML
        st.markdown(f"""
            ...
            <table style="width:100%; border-collapse: collapse; margin-top: 10px; font-size: 14px; background-color: white; color: black; text-align: right; border: 1px solid #cbd5e1;">
                ...
                <tbody>
                    <tr style="border-bottom: 1px solid #e5e7eb;">
                        <td style="padding: 8px; text-align: left; border-right: 1px solid #e5e7eb;"><b>CSPX</b> (50%)</td>
                    ...
                    <tr style="border-bottom: 1px solid #e5e7eb;">
                        <td style="padding: 8px; text-align: left; border-right: 1px solid #e5e7eb;"><b>CNDX</b> (25%)</td>
                    ...
                    <tr style="border-bottom: 1px solid #e5e7eb;">
                        <td style="padding: 8px; text-align: left; border-right: 1px solid #e5e7eb;"><b>Asia</b> (15%)</td>
                    ...
                    <tr style="border-bottom: 1px solid #e5e7eb;">
                        <td style="padding: 8px; text-align: left; border-right: 1px solid #e5e7eb;"><b>Crypto</b> (5%)</td>
                    ...
                    <tr style="border-bottom: 1px solid #e5e7eb;">
                        <td style="padding: 8px; text-align: left; border-right: 1px solid #e5e7eb;"><b>Gold</b> (5%)</td>
