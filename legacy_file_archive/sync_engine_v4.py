...
def sync_tws():
    print("========================================================")
    print("     ESTATE SYNC ENGINE v4 - LIVE TWS CONNECTION")
    print("========================================================")
    ...
    # 3. WARM THE CACHE (Corrected Syntax)
    print("[*] Waking up TWS data streams (this takes 3 seconds)...")
    for acc in accounts:
        # This explicitly commands TWS to start streaming portfolio data
        ib.reqAccountUpdates(acc)
    
    # Give TWS 3 full seconds to push the data over the local network
    ib.sleep(3.0)
