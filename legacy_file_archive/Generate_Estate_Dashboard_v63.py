r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v63.py
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v63.html")
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v63)            ")
print("========================================================")
...
<head>
    ...
    <title>Estate Master Dashboard v63</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8 relative">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v63</p>
            ...
            <div class="xl:col-span-12 mt-2 grid grid-cols-1 xl:grid-cols-12 gap-4">
                ...
                <div class="xl:col-span-4 bg-white border rounded-xl p-4 shadow-sm flex flex-col">
                    ...
                    <div class="mb-4 text-[10px] text-gray-600 leading-tight bg-gray-50 p-2 rounded border border-gray-200">
                        ...
                        <span class="text-green-500 font-bold">VRP Engine:</span> Options premium (Silo C XSP/XND Puts).<br>
    ...
    <script>
        ...
        function updateUI() {
            ...
            // v63 PnL Attribution Donut Plot (Zero-Sum Fix)
        ...
        if (datesPnl && datesPnl.length > 0) {
            ...
            // v63: Find first active trading day to crop "dead air"
            let firstIdx = 0;
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v63 created.")
