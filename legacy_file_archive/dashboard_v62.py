...
3. Launch the UI by running exactly:
   streamlit run dashboard_v62.py
...
def fetch_live_data(ticker_symbol):
    # v62: Safeguard against empty cells during live data-entry
...
def get_exact_opt_margin(df_in):
    ...
    try:
        ...
        # v62 FIX: Added base_tckr to the groupby!
                ...
                try:
                    ...
                    if len(parts) >= 4:
                        ...
                        if right == 'P' and dte > 60:
                            # v62: Broad Market Whitelist prevents Decapitation Bug for Sector Shorts (like SMH)
...
# v62 FIX: Added Physical US Stocks & International Stocks to Core Assets pool
...
if not journal_raw_df.empty:
    ...
    if not active_vrp.empty:
        ...
        # v62: Dynamically map LIVE TWS PnL to calculate Live Annualized ROC
        live_roc_list = []
        live_ann_roc_list = []
        ...
        with tab4:
            ...
            if not cat_df.empty:
                ...
                for _, r in cat_df.iterrows():
                    # v62: Safe extraction preventing NaN crashes during live UI editing
...
if not journal_raw_df.empty:
    ...
    if selected_rows.empty:
        ...
        if str(raw_dte) == 'Closed':
            ...
            # v62: 3D Engine Native Debit Spread & Call Detection
