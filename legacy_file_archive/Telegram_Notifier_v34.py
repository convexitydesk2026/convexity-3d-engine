"""
=============================================================================
Script Name: Telegram_Notifier_v34.py
...
def snap_and_send():
    ...
    # v34 FIX: Pointed to dashboard_pro_v180.py
    streamlit_process = subprocess.Popen(["streamlit", "run", "dashboard_pro_v180.py", "--server.port", "8599", "--server.headless", "true"], cwd=TARGET_DIR, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    time.sleep(12)
