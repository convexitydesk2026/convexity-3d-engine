...
3. Launch the UI by running exactly:
   streamlit run dashboard_v47.py

CHANGELOG (v47):
         - ADDED: 3x10 Grid for Master Estate Aggregation (Simulated SPY/QQQ vs Global).
         - ADDED: SQLite WAL mode to eliminate database lock errors.
         - ADDED: Interactive Editor for the Closed Trades Ledger (Notes & Multi-select Tags).
=============================================================================
"""
...
def load_champion_history():
    ...
    conn.commit()
    # v47: Fetching 'rowid' as primary key to allow precise editing later in the ledger
