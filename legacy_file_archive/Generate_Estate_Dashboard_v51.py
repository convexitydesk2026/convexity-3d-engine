r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v51.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 51 UPGRADES:
         - Fixed the "26 Trillion % IRR" ghost. Added strict mathematical bounds 
           to the Newton-Raphson XIRR function to prevent non-convergence explosions.
         - Engineered 'Live_Allocations.json' receiver. The JavaScript now 
           automatically overwrites the Panel 2 inputs with live IBKR data 
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v51.html") # v51 CHANGE
...
def calculate_xirr(dates, cfs):
    try:
        ...
        # v51 CHANGE: Bounding box to prevent "26 Trillion %" ghosts from massive early cashflows
        if rate > 10.0 or rate < -1.0:
            return 0.0
...
def process_metrics(df_acc):
    ...
    irr_str = f"{(irr * 100):.2f}%" if irr != 0.0 else "N/A" # v51 CHANGE

    calmar_str = "N/A"
    if max_dd < 0 and irr != 0.0:
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v51)            ")
print("========================================================")
...
<head>
    ...
    <title>Estate Master Dashboard v51</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v51</p>
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-white p-4 rounded-xl border shadow-sm">
                    ...
                    <!-- Silo Strategy & Execution Guidelines -->
    ...
    <script>
        ...
        // v51 CHANGE: Auto-Fill the Panel 2 Inputs directly from the Live_Allocations.json file
...
# v51 CHANGE: Load the Live Allocations File generated by the Orchestrator
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v51 created.")
