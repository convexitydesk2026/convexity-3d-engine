...
th_deployed = pos_df[pos_df['asset_class'] == 'Tail Hedge']['market_value'].sum() if not pos_df.empty else 0
...
if not attr_df.empty:
    ...
    th_deployed = pos_df[pos_df['asset_class'] == 'Tail Hedge']['market_value'].sum()
    th_available = th_budget - th_deployed
