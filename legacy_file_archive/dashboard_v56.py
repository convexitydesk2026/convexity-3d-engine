...
3. Launch the UI by running exactly:
   streamlit run dashboard_v56.py

CHANGELOG (v56):
         - PATCHED: get_exact_opt_margin natively understands Debit Spreads ($0 liability).
         - PATCHED: 3D Topography Engine accurately distinguishes Calls/Puts for Debit Spreads.
         - PATCHED: Journal Ledger correctly tracks Debit Spread Capital at Risk for ROC.
=============================================================================
"""
...
if not journal_raw_df.empty:
    ...
    if selected_rows.empty:
        ...
        if str(raw_dte) == 'Closed':
            ...
            # v56: 3D Engine Native Debit Spread Detection
