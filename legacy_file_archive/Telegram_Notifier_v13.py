...
Purpose: Headless Streamlit rendering and Telegram transmission.
         - Updated to target dashboard_v63.py
...
def snap_and_send():
    ...
    # v14 Update: Pointing to dashboard_v63.py
    streamlit_process = subprocess.Popen(["streamlit", "run", "dashboard_v63.py", "--server.port", "8599", "--server.headless", "true"],
        cwd=TARGET_DIR,
