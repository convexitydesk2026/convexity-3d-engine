...
with c_action:
    if distance_usd <= 1000:
        ...
        # --- CEILING GOVERNOR LOGIC (v34 Proportional Overflow) ---
...
if not journal_raw_df.empty:
    ...
    if selected_rows.empty:
        ...
        if str(raw_dte) == 'Closed':
            ...
            with col_2d:
                # --- NEW v34: LIVE TWS P&L EXTRACTION ---
            ...
            with col_3d:
                ...
                # --- v34 ENHANCEMENT: Intersection Curves (Wireframing the Kill Box) ---
                z_green, z_red = [],[]
                for d in y_3d:
