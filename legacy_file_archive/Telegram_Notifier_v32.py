"""
=============================================================================
Script Name: Telegram_Notifier_v32.py
Purpose: Headless Streamlit rendering and Telegram transmission.
         - UPDATED: v32 - Pointed subprocess to dashboard_pro_v178.py
...
def snap_and_send():
    ...
    # v32 FIX: Pointed to dashboard_pro_v178.py
    streamlit_process = subprocess.Popen(["streamlit", "run", "dashboard_pro_v178.py", "--server.port", "8599", "--server.headless", "true"], cwd=TARGET_DIR, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    time.sleep(12)
