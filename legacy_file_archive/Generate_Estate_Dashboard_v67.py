r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v67.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 67 UPGRADES & RESTORATIONS:
         - RESTORED: Exact v65 HTML/JS structural layout and visual aesthetics.
         - RESTORED: All 19 Master Instrument Matrix items and footers.
         - RESTORED: Plotly Zoom/Scroll, dual Y-axis domains, and target legends.
         - UPGRADED: Seamlessly ingests the purified data from Orchestrator v23.
         - UPGRADED: Options Engine Velocity tagged as (v67 Automated).
=============================================================================
"""
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v67.html")
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v67)            ")
print("========================================================")
...
# Process Daily PnL Attribution Charts
...
<head>
    ...
    <title>Estate Master Dashboard v67</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8 relative">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v67</p>
            ...
            <div class="xl:col-span-12 mt-2 grid grid-cols-1 xl:grid-cols-12 gap-4">
                ...
                <div class="xl:col-span-6 bg-white border rounded-xl p-4 shadow-sm flex flex-col">
                    ...
                    <div class="flex flex-col justify-end">
                        <h4 class="text-xs font-black text-gray-500 uppercase tracking-widest mb-3">Options Engine (Silos A & C) Velocity (v67 Automated)</h4>                        
    ...
    <script>
        ...
        function updateUI() {
            ...
            // v67 Progressive Exposure Advisor Inject
            ...
            // -------------------------------------------------------------
            // v67: USD-Denominated PnL Bar Chart & Cumulative Trajectory
            // -------------------------------------------------------------
...
# --- v67 PROGRESSIVE EXPOSURE ADVISORY INJECTION ---
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v67 created.")
