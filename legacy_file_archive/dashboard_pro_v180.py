"""
=============================================================================
Script Name: dashboard_pro_v180.py
...
(Alternatively, open a terminal in this directory and run: streamlit run dashboard_pro_v180.py)

CHANGELOG (v180 PRO):
- STAGE 88 (v180 PRO): UI/UX Polish (Expanders), Institutional Sidebar, and C2 Pitch DB Integration.
...
with st.sidebar:
    ...
    st.markdown("""
    - [🔝 Executive HUD & Alerts](#top)
    - [0. Operational Calendar](#sec0)
    - [1. Master Aggregation](#master-agg)
    - [1B. Return Heatmap](#sec1b)
    - [1C. Institutional Market Flow](#sec1c)
    - [2. GAAP Balance Sheet](#sec1)
    - [3. Portfolio Composition](#sec2)
    - [4. Daily PnL Trajectory](#sec3)
    - [5. Physical Equity Risk Ledger](#sec3b)
    - [6. PnL Attribution & Velocity](#sec4)
    - [7. Deployment Command Center](#sec5)
    - [8. Margin Capacity Tracker](#sec6)
    - [9. Advanced Risk Metrics](#sec6b)
    - [10. S.W.A.N. Stress Test](#sec6c)
    - [11. Master Instrument Matrix](#sec7)
    - [12. Monte Carlo Simulation](#sec8)
    - [13. Options Strategy Matrix](#sec9a)
    - [14. Options Topography Engine](#sec9b)
    - [15. Accountability Journal](#sec10)
