r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v31.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 31 UPGRADES: 
         - Integrated Foreign Momentum UCITS ETFs (ITWN, CSKR, CNYA).
         - Engineered Dynamic "Current Global Alloc. %" column in Matrix.
         - Added Total Checksum row to the Matrix (Must = 100%).
         - Sector/Geo Risk Radars (Semi/Tech concentration alerts).
         - Silo B "Tier 1" Progressive Exposure Tracker.
         - Fully restored Daily PnL Histogram and standard formatting.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v31.html")
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v31)            ")
print("========================================================")
...
if os.path.exists(csv_file_path):
    try:
        ...
        # ---------------------------------------------------------
        # HISTOGRAM DATA (Restored from v30)
        # ---------------------------------------------------------
...
if not bench_df.empty and not global_df.empty:
    ...
    if first_date:
        ...
        master_bench = pd.merge(master_bench, bench_df[['Date', 'SPY Close', 'QQQ Close']], on='Date', how='left')
...
<head>
    ...
    <title>Estate Master Dashboard v31</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v31 (Foreign Diversification & Risk Radars)</p>
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-gray-100 p-4 rounded-xl shadow-md border border-gray-300 relative">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4 text-sm mt-3 border-t border-gray-300 pt-3 font-mono text-center">
                        <div>Balance<br><span class="text-blue-700 font-black text-lg">VAR_ESTATE_NAV_FMT</span></div>
                        ...
                        <div>Sharpe<br><span class="VAR_COLOR_ESTATE_SHARPE font-black text-lg">VAR_ESTATE_SHARPE</span></div>
                        <div>Max DD<br><span class="text-red-600 font-black text-lg">VAR_ESTATE_MAXDD</span></div>
                        <div>DD Days<br><span class="text-gray-800 font-black text-lg">VAR_ESTATE_DD_DAYS</span></div>
                        <div>Calmar<br><span class="text-gray-800 font-black text-lg">VAR_ESTATE_CALMAR</span></div>
                        <div>ROC%<br><span class="VAR_COLOR_ESTATE_ROC font-black text-lg">VAR_ESTATE_ROC</span></div>
                    </div>
                </div>

                <!-- RISK RADARS (Sector, Geo, Cash Drag) -->
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 2xl:grid-cols-4 gap-4">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="bg-blue-300 text-gray-900 p-4 rounded-xl shadow-md text-center border-b-4 border-blue-400 flex-grow">
                            <h4 class="text-sm text-gray-900 uppercase tracking-widest font-black mb-1">Silo A (Vault)</h4>
                            ...
                            <div class="grid grid-cols-2 text-xs mt-3 border-t border-blue-400 pt-3 font-mono">
                                <div class="text-left font-bold">IRR: <span class="VAR_COLOR_A_IRR">VAR_A_IRR</span></div>
                                <div class="text-right font-bold">Sharpe: <span class="VAR_COLOR_A_SHARPE">VAR_A_SHARPE</span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="bg-purple-300 text-gray-900 p-4 rounded-xl shadow-md text-center border-b-4 border-purple-400 flex-grow relative">
                            <h4 class="text-sm text-gray-900 uppercase tracking-widest font-black mb-1">Silo B (Alpha Sandbox)</h4>
                            ...
                            <div class="mt-2 p-2 bg-purple-100 border border-purple-400 rounded text-[10px] text-left">
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="bg-green-300 text-gray-900 p-4 rounded-xl shadow-md text-center border-b-4 border-green-400 flex-grow">
                            <h4 class="text-sm text-gray-900 uppercase tracking-widest font-black mb-1">Silo C (Income)</h4>
                            ...
                            <div class="grid grid-cols-2 text-xs mt-3 border-t border-green-400 pt-3 font-mono">
                                <div class="text-left font-bold">IRR: <span class="VAR_COLOR_C_IRR">VAR_C_IRR</span></div>
                                <div class="text-right font-bold">Sharpe: <span class="VAR_COLOR_C_SHARPE">VAR_C_SHARPE</span></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex flex-col gap-3">
                        ...
                        <div class="bg-yellow-300 text-gray-900 p-4 rounded-xl shadow-md text-center border-b-4 border-yellow-400 flex-grow">
                            <h4 class="text-sm text-gray-900 uppercase tracking-widest font-black mb-1">Silo D (Vault)</h4>
                            ...
                            <div class="grid grid-cols-2 text-xs mt-3 border-t border-yellow-400 pt-3 font-mono">
                                <div class="text-left font-bold">IRR: <span class="VAR_COLOR_D_IRR">VAR_D_IRR</span></div>
                                <div class="text-right font-bold">Sharpe: <span class="VAR_COLOR_D_SHARPE">VAR_D_SHARPE</span></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <!-- TARGET ALLOCATION SLIDERS (v31 expanded) -->
                <div class="bg-white p-4 rounded-xl border shadow-sm flex-grow">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                        ...
                        <!-- Silo A -->
                        <div class="bg-blue-50 p-3 rounded-lg border border-blue-400 shadow-inner overflow-y-auto max-h-[400px]">
                            <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-blue-400 pb-1">Silo A</h4>
                            <label class="text-[10px] font-bold text-gray-900" id="a_ib01_label">IB01: </label><input type="range" id="a_ib01" min="0" max="100" step="0.01" value="100.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_cspx_label">CSPX: </label><input type="range" id="a_cspx" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_cndx_label">CNDX: </label><input type="range" id="a_cndx" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_itwn_label">ITWN (Taiwan): </label><input type="range" id="a_itwn" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_cskr_label">CSKR (Korea): </label><input type="range" id="a_cskr" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_cnya_label">CNYA (China): </label><input type="range" id="a_cnya" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_crypto_label">Crypto ETPs: </label><input type="range" id="a_crypto" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="a_cash_label">Cash: </label><input type="range" id="a_cash" min="-50" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-red-600" id="a_opt_mkt_label">Opt. Mkt Val (Liab): </label><input type="range" id="a_opt_mkt" min="-20" max="0" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <p class="text-[10px] text-red-600 font-bold mt-1 h-4" id="a_warning"></p>
                            <label class="text-[10px] font-bold text-green-700 border-t border-blue-300 pt-1" id="a_xsp_label">Opt Margin: </label><input type="range" id="a_xsp" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                        </div>

                        <!-- Silo B -->
                        <div class="bg-purple-50 p-3 rounded-lg border border-purple-400 shadow-inner overflow-y-auto max-h-[400px]">
                            <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-purple-400 pb-1">Silo B</h4>
                            <label class="text-[10px] font-bold text-gray-900" id="b_ib01_label">IB01: </label><input type="range" id="b_ib01" min="0" max="100" step="0.01" value="41.15" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_cash_label">Cash: </label><input type="range" id="b_cash" min="-50" max="100" step="0.01" value="58.85" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_cfd_label">US Tech CFDs: </label><input type="range" id="b_cfd" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_intl_label">Intl Stocks: </label><input type="range" id="b_intl" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_itwn_label">ITWN (Taiwan): </label><input type="range" id="b_itwn" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_cskr_label">CSKR (Korea): </label><input type="range" id="b_cskr" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="b_cnya_label">CNYA (China): </label><input type="range" id="b_cnya" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <p class="text-[10px] text-red-600 font-bold mt-1 h-4" id="b_warning"></p>
                        </div>

                        <!-- Silo C -->
                        <div class="bg-green-50 p-3 rounded-lg border border-green-400 shadow-inner overflow-y-auto max-h-[400px]">
                            <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-green-400 pb-1">Silo C</h4>
                            <label class="text-[10px] font-bold text-gray-900" id="c_ib01_label">IB01: </label><input type="range" id="c_ib01" min="0" max="100" step="0.01" value="100.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_cspx_label">CSPX: </label><input type="range" id="c_cspx" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_cndx_label">CNDX: </label><input type="range" id="c_cndx" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_itwn_label">ITWN (Taiwan): </label><input type="range" id="c_itwn" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_cskr_label">CSKR (Korea): </label><input type="range" id="c_cskr" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_cnya_label">CNYA (China): </label><input type="range" id="c_cnya" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_crypto_label">Crypto ETPs: </label><input type="range" id="c_crypto" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="c_cash_label">Cash: </label><input type="range" id="c_cash" min="-50" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-red-600" id="c_opt_mkt_label">Opt. Mkt Val (Liab): </label><input type="range" id="c_opt_mkt" min="-20" max="0" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <p class="text-[10px] text-red-600 font-bold mt-1 h-4" id="c_warning"></p>
                            <label class="text-[10px] font-bold text-green-700 border-t border-green-300 pt-1" id="c_xsp_label">Opt Margin: </label><input type="range" id="c_xsp" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                        </div>

                        <!-- Silo D -->
                        <div class="bg-yellow-50 p-3 rounded-lg border border-yellow-400 shadow-inner overflow-y-auto max-h-[400px]">
                            <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-yellow-400 pb-1">Silo D</h4>
                            <label class="text-[10px] font-bold text-gray-900" id="d_ib01_label">IB01: </label><input type="range" id="d_ib01" min="0" max="100" step="0.01" value="40.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_cspx_label">CSPX: </label><input type="range" id="d_cspx" min="0" max="100" step="0.01" value="30.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_cndx_label">CNDX: </label><input type="range" id="d_cndx" min="0" max="100" step="0.01" value="15.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_itwn_label">ITWN (Taiwan): </label><input type="range" id="d_itwn" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_cskr_label">CSKR (Korea): </label><input type="range" id="d_cskr" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_cnya_label">CNYA (China): </label><input type="range" id="d_cnya" min="0" max="100" step="0.01" value="0.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_crypto_label">Crypto ETPs: </label><input type="range" id="d_crypto" min="0" max="100" step="0.01" value="5.0" class="w-full mb-1" oninput="updateUI()">
                            <label class="text-[10px] font-bold text-gray-900" id="d_cash_label">Cash: </label><input type="range" id="d_cash" min="-50" max="100" step="0.01" value="10.0" class="w-full mb-1" oninput="updateUI()">
            ...
            <!-- DAILY PNL HISTOGRAM (Restored from v30) -->
            ...
            <div class="xl:col-span-12 mt-2">
                <div class="bg-white border rounded-xl p-4 shadow-sm overflow-hidden">
                    <h3 class="text-xl font-bold mb-4 text-gray-800 border-b pb-2">4. Estate Montecarlo PnL Simulation (Profit in $)</h3>
                ...
                <div class="bg-white border rounded-xl p-4 shadow-sm overflow-x-auto">
                    ...
                    <table class="min-w-full bg-white text-[12px] whitespace-nowrap border-collapse">
                        ...
                        <tfoot class="bg-gray-100 font-bold text-gray-900 border-t-2 border-gray-400">
                            <tr>
                                <td colspan="8" class="py-3 px-3 text-right">TOTAL PHYSICAL ASSET CHECKSUM:</td>
                                <td class="py-3 px-3 text-center text-blue-700 text-sm" id="alloc_total">0.00%</td>
                                <td colspan="2" class="py-3 px-3 text-left text-[10px] text-gray-500">Must exactly equal 100.00%</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
    ...
    <script>
        ...
        const instruments =[
            { id: "cash", inst: "USD Cash", type: "Currency", risk: "Risk-Free", alpha: "Zero", sharpe: "Stabilizer", jur: "US (IBKR)", tax: "Exempt", min: "1%", max: "100%", rec: "Splendid", class: "splendid" },
            { id: "ib01", inst: "IB01", type: "UCITS ETF", risk: "Risk-Free", alpha: "Zero", sharpe: "High", jur: "Ireland", tax: "Exempt", min: "10%", max: "100%", rec: "Splendid", class: "splendid" },
            { id: "xsp", inst: "XSP Put Spreads", type: "Index Option", risk: "Moderate", alpha: "High", sharpe: "High", jur: "US (Cboe)", tax: "Exempt", min: "0%", max: "25%", rec: "Splendid", class: "splendid" },
            { id: "xnd", inst: "XND Put Spreads", type: "Index Option", risk: "Mod/High", alpha: "High", sharpe: "Moderate", jur: "US (Cboe)", tax: "Exempt", min: "0%", max: "10%", rec: "Great", class: "great" },
            { id: "cspx", inst: "CSPX", type: "UCITS ETF", risk: "Moderate", alpha: "Zero", sharpe: "Baseline", jur: "Ireland", tax: "Exempt", min: "0%", max: "60%", rec: "Great", class: "great" },
            { id: "cndx", inst: "CNDX", type: "UCITS ETF", risk: "Aggressive", alpha: "High", sharpe: "Moderate", jur: "Ireland", tax: "Exempt", min: "0%", max: "40%", rec: "Great", class: "great" },
            { id: "itwn", inst: "ITWN (Taiwan)", type: "UCITS ETF", risk: "Aggressive", alpha: "High", sharpe: "Moderate", jur: "Ireland", tax: "Exempt", min: "0%", max: "20%", rec: "Great", class: "great" },
            { id: "cskr", inst: "CSKR (Korea)", type: "UCITS ETF", risk: "Aggressive", alpha: "High", sharpe: "Moderate", jur: "Ireland", tax: "Exempt", min: "0%", max: "15%", rec: "Great", class: "great" },
            { id: "cnya", inst: "CNYA (China)", type: "UCITS ETF", risk: "Aggressive", alpha: "High", sharpe: "Volatile", jur: "Ireland", tax: "Exempt", min: "0%", max: "10%", rec: "Great", class: "great" },
            { id: "crypto", inst: "BTC/ETH ETPs", type: "Crypto ETP", risk: "Aggressive", alpha: "High", sharpe: "Volatile", jur: "Europe", tax: "Exempt", min: "0%", max: "5%", rec: "Good", class: "good" },
            { id: "cfd", inst: "US Tech CFDs", type: "OTC Contract", risk: "Aggressive", alpha: "High", sharpe: "Negative", jur: "UK/Offshore", tax: "Exempt", min: "0%", max: "3%", rec: "Good", class: "good" },
            { id: "intl", inst: "International Stocks", type: "Direct Equity", risk: "Aggressive", alpha: "High", sharpe: "Negative", jur: "Europe/Asia", tax: "Exempt", min: "0%", max: "3%", rec: "Good", class: "good" },
            { id: "leaps", inst: "XSP LEAPS", type: "Index Option", risk: "Aggressive", alpha: "Low", sharpe: "Negative", jur: "US (Cboe)", tax: "Exempt", min: "0%", max: "0%", rec: "Bad", class: "bad" },
            { id: "phys", inst: "Physical US Stocks", type: "Stock", risk: "Extreme", alpha: "High", sharpe: "Baseline", jur: "US", tax: "LETHAL (40% Tax)", min: "0%", max: "0%", rec: "Avoid", class: "avoid" }
        ];
        ...
        function updateUI() {
            ...
            let a_cndx = parseFloat(document.getElementById('a_cndx').value); let a_crypto = parseFloat(document.getElementById('a_crypto').value); 
            let a_cash = parseFloat(document.getElementById('a_cash').value); let a_itwn = parseFloat(document.getElementById('a_itwn').value);
            let a_cskr = parseFloat(document.getElementById('a_cskr').value); let a_cnya = parseFloat(document.getElementById('a_cnya').value);
            let a_opt_mkt = parseFloat(document.getElementById('a_opt_mkt').value); let a_xsp = parseFloat(document.getElementById('a_xsp').value);
            let a_tot = a_ib01 + a_cspx + a_cndx + a_itwn + a_cskr + a_cnya + a_crypto + a_cash + a_opt_mkt;
            ...
            const amt_A_itwn = sA*(a_itwn/100); const amt_A_cskr = sA*(a_cskr/100); const amt_A_cnya = sA*(a_cnya/100);
            ...
            document.getElementById('a_itwn_label').innerText = `ITWN: ${fmtCur(amt_A_itwn)} (${a_itwn.toFixed(2)}%)`;
            document.getElementById('a_cskr_label').innerText = `CSKR: ${fmtCur(amt_A_cskr)} (${a_cskr.toFixed(2)}%)`;
            document.getElementById('a_cnya_label').innerText = `CNYA: ${fmtCur(amt_A_cnya)} (${a_cnya.toFixed(2)}%)`;
            document.getElementById('a_crypto_label').innerText = `Crypto: ${fmtCur(amt_A_crypto)} (${a_crypto.toFixed(2)}%)`;
            document.getElementById('a_cash_label').innerText = `Cash: ${fmtCur(amt_A_cash)} (${a_cash.toFixed(2)}%)`;
            document.getElementById('a_opt_mkt_label').innerText = `Opt Liab: ${fmtCur(amt_A_opt_mkt)} (${a_opt_mkt.toFixed(2)}%)`;
            document.getElementById('a_xsp_label').innerText = `Margin: ${fmtCur(amt_A_xsp)} (${a_xsp.toFixed(2)}%)`;
            ...
            let b_itwn = parseFloat(document.getElementById('b_itwn').value); let b_cskr = parseFloat(document.getElementById('b_cskr').value); 
            let b_cnya = parseFloat(document.getElementById('b_cnya').value);
            let b_tot = b_ib01 + b_cash + b_cfd + b_intl + b_itwn + b_cskr + b_cnya;
            ...
            const amt_B_itwn = sB*(b_itwn/100); const amt_B_cskr = sB*(b_cskr/100); const amt_B_cnya = sB*(b_cnya/100);
            ...
            document.getElementById('b_intl_label').innerText = `Intl: ${fmtCur(amt_B_intl)} (${b_intl.toFixed(2)}%)`;
            document.getElementById('b_itwn_label').innerText = `ITWN: ${fmtCur(amt_B_itwn)} (${b_itwn.toFixed(2)}%)`;
            document.getElementById('b_cskr_label').innerText = `CSKR: ${fmtCur(amt_B_cskr)} (${b_cskr.toFixed(2)}%)`;
            document.getElementById('b_cnya_label').innerText = `CNYA: ${fmtCur(amt_B_cnya)} (${b_cnya.toFixed(2)}%)`;

            // Silo C
            let c_ib01 = parseFloat(document.getElementById('c_ib01').value); let c_cspx = parseFloat(document.getElementById('c_cspx').value);
            let c_cndx = parseFloat(document.getElementById('c_cndx').value); let c_crypto = parseFloat(document.getElementById('c_crypto').value); 
            let c_cash = parseFloat(document.getElementById('c_cash').value); let c_itwn = parseFloat(document.getElementById('c_itwn').value);
            let c_cskr = parseFloat(document.getElementById('c_cskr').value); let c_cnya = parseFloat(document.getElementById('c_cnya').value);
            let c_opt_mkt = parseFloat(document.getElementById('c_opt_mkt').value); let c_xsp = parseFloat(document.getElementById('c_xsp').value);
            let c_tot = c_ib01 + c_cspx + c_cndx + c_itwn + c_cskr + c_cnya + c_crypto + c_cash + c_opt_mkt;
            ...
            const amt_C_itwn = sC*(c_itwn/100); const amt_C_cskr = sC*(c_cskr/100); const amt_C_cnya = sC*(c_cnya/100);
            ...
            document.getElementById('c_itwn_label').innerText = `ITWN: ${fmtCur(amt_C_itwn)} (${c_itwn.toFixed(2)}%)`;
            document.getElementById('c_cskr_label').innerText = `CSKR: ${fmtCur(amt_C_cskr)} (${c_cskr.toFixed(2)}%)`;
            document.getElementById('c_cnya_label').innerText = `CNYA: ${fmtCur(amt_C_cnya)} (${c_cnya.toFixed(2)}%)`;
            document.getElementById('c_crypto_label').innerText = `Crypto: ${fmtCur(amt_C_crypto)} (${c_crypto.toFixed(2)}%)`;
            document.getElementById('c_cash_label').innerText = `Cash: ${fmtCur(amt_C_cash)} (${c_cash.toFixed(2)}%)`;
            document.getElementById('c_opt_mkt_label').innerText = `Opt Liab: ${fmtCur(amt_C_opt_mkt)} (${c_opt_mkt.toFixed(2)}%)`;
            document.getElementById('c_xsp_label').innerText = `Margin: ${fmtCur(amt_C_xsp)} (${c_xsp.toFixed(2)}%)`;

            // Silo D
            let d_ib01 = parseFloat(document.getElementById('d_ib01').value); let d_cspx = parseFloat(document.getElementById('d_cspx').value);
            let d_cndx = parseFloat(document.getElementById('d_cndx').value); let d_crypto = parseFloat(document.getElementById('d_crypto').value); 
            let d_cash = parseFloat(document.getElementById('d_cash').value); let d_itwn = parseFloat(document.getElementById('d_itwn').value);
            let d_cskr = parseFloat(document.getElementById('d_cskr').value); let d_cnya = parseFloat(document.getElementById('d_cnya').value);
            let d_tot = d_ib01 + d_cspx + d_cndx + d_itwn + d_cskr + d_cnya + d_crypto + d_cash;
            ...
            const amt_D_itwn = sD*(d_itwn/100); const amt_D_cskr = sD*(d_cskr/100); const amt_D_cnya = sD*(d_cnya/100);
            ...
            document.getElementById('d_itwn_label').innerText = `ITWN: ${fmtCur(amt_D_itwn)} (${d_itwn.toFixed(2)}%)`;
            document.getElementById('d_cskr_label').innerText = `CSKR: ${fmtCur(amt_D_cskr)} (${d_cskr.toFixed(2)}%)`;
            document.getElementById('d_cnya_label').innerText = `CNYA: ${fmtCur(amt_D_cnya)} (${d_cnya.toFixed(2)}%)`;
            document.getElementById('d_crypto_label').innerText = `Crypto: ${fmtCur(amt_D_crypto)} (${d_crypto.toFixed(2)}%)`;
            ...
            let tot_itwn = amt_A_itwn + amt_B_itwn + amt_C_itwn + amt_D_itwn;
            let tot_cskr = amt_A_cskr + amt_B_cskr + amt_C_cskr + amt_D_cskr;
            let tot_cnya = amt_A_cnya + amt_B_cnya + amt_C_cnya + amt_D_cnya;
            ...
            // Risk Alerts Logic
            let techSemiPct = totalEstate > 0 ? ((tot_cndx + tot_itwn + tot_cskr + amt_B_cfd) / totalEstate) * 100 : 0;
            ...
            const allocMap = {
                ...
                "BTC/ETH ETPs": tot_crypto, "US Tech CFDs": amt_B_cfd, "International Stocks": amt_B_intl
            };
            ...
            instruments.forEach(i => {
                ...
                if (el) {
                    if (allocMap[i.inst] !== undefined) {
                        ...
                        el.innerText = "N/A"; // Options/Margins do not count towards the 100% physical base
            ...
            // Charts Formatting Logic (Expanded from minified)
            const xLabels = ['Silo A', 'Silo B', 'Silo C', 'Silo D'];
            let barData = [
                { x: xLabels, y:[amt_A_ib01, amt_B_ib01, amt_C_ib01, amt_D_ib01], name: 'IB01', type: 'bar', marker: {color: palette.siloA} },
                ...
                { x: xLabels, y:[amt_A_itwn, amt_B_itwn, amt_C_itwn, amt_D_itwn], name: 'ITWN', type: 'bar', marker: {color: palette.itwn} },
                { x: xLabels, y:[amt_A_cskr, amt_B_cskr, amt_C_cskr, amt_D_cskr], name: 'CSKR', type: 'bar', marker: {color: palette.cskr} },
                { x: xLabels, y:[amt_A_cnya, amt_B_cnya, amt_C_cnya, amt_D_cnya], name: 'CNYA', type: 'bar', marker: {color: palette.cnya} },
                { x: xLabels, y:[amt_A_crypto, 0, amt_C_crypto, amt_D_crypto], name: 'Crypto', type: 'bar', marker: {color: palette.crypto} },
                { x: xLabels, y:[0, (amt_B_cfd+amt_B_intl), 0, 0], name: 'CFDs/Intl', type: 'bar', marker: {color: palette.cfd_intl} },
            ...
            let rawPieData =[
                ...
                {v: (amt_B_cfd+amt_B_intl), l: `Active Swing: ${fmtCur(amt_B_cfd+amt_B_intl)}`, c: palette.cfd_intl}, 
        ...
        // ---------------------------------------------------------
        // BENCHMARKS, PNL, & MONTE CARLO INJECTION
        // ---------------------------------------------------------
        ...
        if (benchDates && benchDates.length > 0) {
            ...
            Plotly.react('chart-silo-a',[{ x: benchDates, y: safeParse('VAR_SILOA_CUM'), type: 'scatter', mode: 'lines', line: {color: 'black', width: 3} }], layoutSm, {displayModeBar: false});
            Plotly.react('chart-silo-b',[{ x: benchDates, y: safeParse('VAR_SILOB_CUM'), type: 'scatter', mode: 'lines', line: {color: 'black', width: 3} }], layoutSm, {displayModeBar: false});
            Plotly.react('chart-silo-c',[{ x: benchDates, y: safeParse('VAR_SILOC_CUM'), type: 'scatter', mode: 'lines', line: {color: 'black', width: 3} }], layoutSm, {displayModeBar: false});
            Plotly.react('chart-silo-d',[{ x: benchDates, y: safeParse('VAR_SILOD_CUM'), type: 'scatter', mode: 'lines', line: {color: 'black', width: 3} }], layoutSm, {displayModeBar: false});
        }

        // Daily PnL Histogram Logic (Restored from v30)
        ...
        if (datesPnl && datesPnl.length > 0) {
            ...
            let pnlLayout = {
                ...
                yaxis: { title: 'Daily PnL (USD)', side: 'left', zeroline: true, zerolinecolor: '#9ca3af', zerolinewidth: 2 },
                yaxis2: { title: 'Cumulative PnL (USD)', side: 'right', overlaying: 'y', showgrid: false, zeroline: false },
                legend: { orientation: 'h', y: 1.1, x: 0.5, xanchor: 'center' }
            };
            Plotly.react('daily-pnl-chart',[traceA, traceB, traceC, traceD, traceEstateLine, traceSPYLine, traceQQQLine], pnlLayout, {displayModeBar: false, responsive: true});
        }

        const mcOrig = safeParse('VAR_MC_ORIG');
        if (mcOrig && mcOrig.length > 0) {
            let mcTraces =[];
            safeParse('VAR_MC_VISUALS').forEach(tr => mcTraces.push({ y: tr, type: 'scatter', mode: 'lines', line: {color: 'rgba(100,100,100,0.1)', width: 1}, hoverinfo: 'skip' }));
            mcTraces.push({ y: safeParse('VAR_MC_AVG'), name: 'Avg Path', type: 'scatter', mode: 'lines', line: {color: 'blue', width: 3} });
            mcTraces.push({ y: mcOrig, name: 'History', type: 'scatter', mode: 'lines', line: {color: 'black', width: 3} });
            ...
            let mcLayout = {
                ...
                yaxis: { title: 'Cumulative Net Profit (USD)' },
                showlegend: false
            };
...
# Re-injected Daily PnL Histogram variables
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v31 (Fully Restored Edition) created.")
