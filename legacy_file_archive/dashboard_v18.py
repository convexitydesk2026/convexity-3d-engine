"""
=============================================================================
Script Name: dashboard_v18.py
Purpose: The Streamlit Frontend (Module 18 - Analytical Expansion & Bug Fixes).
         - Fixed HTML parsing crash dynamically via .replace('\\n', '').
         - Added "Executive Briefing & Alerts" panel for Telegram screenshot pickup.
         - Upgraded Monte Carlo panel with Risk of Ruin math and solid trace colors.
         - Implemented exclusive-checkbox warning for the Options 3D Visualizer.
         - Appended inline legends for the Silo mini-charts.
=============================================================================
"""
...
def get_active_scripts():
    ...
    return " • ".join(scripts) if scripts else "dashboard_v18.py"

active_scripts_str = get_active_scripts() + " (Auto-detected Latest Known)"
...
def load_benchmarks(start_date, end_date):
    # Expanded start_date to -300 days to reliably calculate the 200 SMA
...
strats =[
    ...
    "<b>STRATEGY & EXECUTION:</b><br>Adheres to Silo A/C 40% cash buffer. Execute XSP/XND spreads weekly at 45-50 DTE near -0.20 Delta. Strict 8% premium floor. 50% GTC take-profit set instantly. Never manually close before 21 DTE to avoid Gamma risk.",
