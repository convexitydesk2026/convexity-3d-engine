"""
=============================================================================
Script Name: Telegram_Notifier_v12.py
Purpose: Headless Streamlit rendering and Telegram transmission.
         - Updated to target dashboard_v48.py
         - Added dynamic scroll loop to render lazy-loaded components.
=============================================================================
"""
...
def snap_and_send():
    ...
    streamlit_process = subprocess.Popen(["streamlit", "run", "dashboard_v48.py", "--server.port", "8599", "--server.headless", "true"],
        cwd=TARGET_DIR,
    ...
    try:
        ...
        with sync_playwright() as p:
            ...
            # EXTENDED wait time to 40 seconds to ensure APIs finish loading
