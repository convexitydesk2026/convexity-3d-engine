"""
=============================================================================
Script Name: attribution_engine_v23a.py
Purpose: Parses the official IBKR Flex Query (MTM and CNAV).
         - V23 FIX: Aggressive filter to eliminate all IBKR MTMP "Subtotal" rows.
         - FIXED: Restored Cash/FX PnL by refining the "Total" row exclusion filter.
...
def run_attribution():
    print("========================================================")
    print("   ESTATE P&L ATTRIBUTION ENGINE (v23a FULL AUTOMATION)")
        ...
        for row in reader:
            ...
            # -- EXTRACT DATA --
                ...
                # --- MARK-TO-MARKET PERFORMANCE SECTION (MTMP) ---
                    ...
                    # Drop Asset Class subtotals (they have empty symbols but aren't Cash/FX)
                    if not sym_str and 'cash' not in ac_str and 'fx' not in ac_str:
                        continue
    ...
    # -------------------------------------------------------------------------
    # WRITE CASH FLOWS & ATTRIBUTION (v23a: DYNAMIC STITCHING)
    # -------------------------------------------------------------------------
    ...
    print("[+] SUCCESS: v23a Engine Complete. Infinite Data Stitching Deployed.\n")
