r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v11.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 11: 
         - Restored beneficiaries (Persons 1 and 2, etc.) to the Silo headers.
         - Removed specialized co-titles (Vault, Active, Options).
         - Privacy masking applied to IBKR Account Numbers (e.g., U*****199).
         - Retains v10 Max Drawdown fix, Silo D colors, and the full Master Matrix.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v11.html")
...
<head>
    ...
    <title>Family Estate Master Allocator v11</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[1800px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v11</p>
        </div>
    ...
    <script>
        ...
        const instruments =[
            ...
            { inst: "XSP LEAPS", type: "Index Option", risk: "High (Time Risk)", alpha: "High (Leverage)", sharpe: "Negative (High leverage variance)", strat: "Multi-Year Swing", jur: "US (Cboe)", min: "0%", max: "10%", rec: "Good", class: "good", comm: "<strong>Deep ITM Call options expiring in 1 to 3 years.</strong><br>Capital efficient stock replacement safe from IRS. Suffers from 3.5% annual time/dividend drag. Strict 10% limit to prevent excessive Theta exposure." },
            { inst: "Intl Stocks (Direct)", type: "Stock", risk: "Aggressive", alpha: "High", sharpe: "Negative", strat: "Swing Trading", jur: "Europe/Asia", min: "0%", max: "3%", rec: "Neutral", class: "good", comm: "<strong>Direct ownership of non-US physical equities.</strong><br>Safe from IRS. Wider bid/ask spreads and liquidity constraints compared to US Tech. Same 3% quarantine limit as CFDs." },
            { inst: "US Corp Bonds", type: "Bond/Stock", risk: "Moderate", alpha: "Negative", sharpe: "Negative (Credit Widening Risk)", strat: "Income", jur: "US / Ireland", min: "0%", max: "0%", rec: "Bad", class: "bad", comm: "<strong>Debt issued by US corporations, or ETFs holding dividend-yielding equities.</strong><br>Di-worsification. Crashes during Black Swans alongside stocks. 0% allocation because tax drag on yields is too severe for NRAs." },
            { inst: "Physical US Stocks", type: "Stock", risk: "Aggressive", alpha: "High", sharpe: "Baseline", strat: "Swing / Hold", jur: "US (Nasdaq)", min: "0%", max: "0%", rec: "Avoid", class: "avoid", comm: "<strong>Shares traded on US exchanges (e.g., AAPL, TSLA, SPY).</strong><br>LETHAL. Triggers 40% US Estate Tax and 30% Dividend Withholding. 0% absolute prohibition for Dominican Republic residents." },
            { inst: "US Stock Options", type: "Option", risk: "Extreme", alpha: "High", sharpe: "Negative", strat: "Speculation", jur: "US (Cboe)", min: "0%", max: "0%", rec: "Avoid", class: "avoid", comm: "<strong>Contracts granting the right to buy/sell physical US property.</strong><br>LETHAL. IRS gray area. Brokers will aggressively freeze the account for months upon death. 0% absolute prohibition." }
        ];
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v11 created.")
