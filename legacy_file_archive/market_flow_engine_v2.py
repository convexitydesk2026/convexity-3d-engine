...
Launch the UI by running exactly: streamlit run market_flow_engine_v2.py             
Author:      Virtual CFO
Date:        July 2026
Version:     2.0 (Playwright PDF Integration)
================================================================================
"""
...
html = '''<!DOCTYPE html><html><head><meta charset="UTF-8"><title>Institutional Flow Dashboard (v2)</title>
<style>
...
try:
    with sync_playwright() as p:
        ...
        # Convert local path to file URI for Playwright
        ...
        # Snap as Landscape A3 so the wide tables fit cleanly
