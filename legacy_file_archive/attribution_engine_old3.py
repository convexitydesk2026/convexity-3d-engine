...
Purpose: Calculates daily PnL split across 5 strategic buckets and appends
         ...
         (Phase 6 Fix: Routes positive drift to Yield, negative to Fees)
=============================================================================
"""
import sqlite3
import pandas as pd
...
def run_attribution():
    print("========================================================")
    print("   ESTATE P&L ATTRIBUTION ENGINE (PHASE 6)")
    print("========================================================")
    ...
    for i in range(len(dates)):
        ...
        if abs(diff_pnl) > 0.01:
            if len(dropped_buckets) > 0:
                ...
                # PHASE 6 FIX: Route positive unaccounted drift to Yield, negative to Fees
                if diff_pnl > 0:
    ...
    print("[+] Engine Rewrite Complete. PnL Amnesia & Fee Drifts Resolved.")
