...
streamlit run dashboard_v150.py
CHANGELOG (v150):
- STAGE 57 (v150): Reset v7.0 Amnesty Inception Date to July 17, 2026, to clear phantom test losses and unlock the Alpha Risk Calculator.
...
with calc_placeholder.container():
    ...
    # Protocol v7.0 Inception Reset (July 17, 2026)
