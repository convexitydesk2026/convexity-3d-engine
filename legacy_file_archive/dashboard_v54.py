...
3. Launch the UI by running exactly:
   streamlit run dashboard_v54.py

CHANGELOG (v54):
         - PATCHED: Black-Scholes log(S/K) division-by-zero crash for 0 strikes.
         - PATCHED: Plotly go.Scatter NaN size parameter crash.
=============================================================================
"""
