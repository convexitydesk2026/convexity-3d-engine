"""
=============================================================================
Script Name: Telegram_Notifier_v8.py
Purpose: Headless Streamlit rendering and Telegram transmission.
         - Updated to target dashboard_v40.py (Phase 6).
...
def snap_and_send():
    ...
    # UPDATED to target dashboard_v40.py for Phase 6
    streamlit_process = subprocess.Popen(["streamlit", "run", "dashboard_v40.py", "--server.port", "8599", "--server.headless", "true"],
        cwd=TARGET_DIR,
