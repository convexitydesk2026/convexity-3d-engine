...
3. Launch the UI by running exactly:
   streamlit run dashboard_v58.py

CHANGELOG (v58):
         - AMPUTATED: Completely removed Section 10 (Champion Journal, TOR Ledger, Expectancy Calculator, and Tags) to finalize institutional Barbell transition.
=============================================================================
"""
...
if not journal_raw_df.empty:
    ...
    if selected_rows.empty:
        ...
        if str(raw_dte) == 'Closed':
            ...
            # v58: 3D Engine Native Debit Spread Detection
