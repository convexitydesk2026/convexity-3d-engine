r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v34.py
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v34.html")
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v34)            ")
print("========================================================")
...
<head>
    ...
    <title>Estate Master Dashboard v34</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v34</p>
        </div>
    ...
    <script>
        ...
        if (datesPnl && datesPnl.length > 0) {
            ...
            let pnlLayout = {
                ...
                yaxis: { title: 'Daily PnL (USD)', side: 'left', showgrid: true, gridcolor: '#e5e7eb', zeroline: true, zerolinecolor: '#9ca3af', zerolinewidth: 2 },
        ...
        if (mcOrig && mcOrig.length > 0) {
            let mcTraces =[];
            safeParse('VAR_MC_VISUALS').forEach(tr => mcTraces.push({ y: tr, type: 'scatter', mode: 'lines', line: {color: 'rgba(100,100,100,0.1)', width: 1}, showlegend: false, hoverinfo: 'skip' }));
            mcTraces.push({ y: safeParse('VAR_MC_AVG'), name: 'Avg Path (Stable)', type: 'scatter', mode: 'lines', line: {color: 'blue', width: 3} });
            mcTraces.push({ y: mcOrig, name: 'Original History', type: 'scatter', mode: 'lines', line: {color: 'black', width: 3} });
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v34 created.")
