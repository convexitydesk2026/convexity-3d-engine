r"""
=============================================================================
Script Name: Estate_Orchestrator_v4.py
File Path: C:\Users\donca\Desktop\Desktop HP Envy x360 al 22Abr24\Docs Manuel\IBKR_Options\Estate_Orchestrator_v4.py
Purpose: The Zero-Touch Automation Engine for the Family Office.
         V4 UPGRADES:
         - Added explicit date formatting to pandas pd.to_datetime() to 
           permanently silence the "Could not infer format" UserWarning.
         - Maintains resilient error handling for IBKR 1001 API rejections.
...
def update_yfinance_data():
    ...
    try:
        if os.path.exists(spy_csv_path):
            ...
            # v4 CHANGE: Added strict format matching to avoid pandas guessing logic warnings
...
if __name__ == "__main__":
    print("========================================================")
    print("     ESTATE ORCHESTRATOR v4 - INITIALIZING SYNC...      ")
    print("========================================================")
