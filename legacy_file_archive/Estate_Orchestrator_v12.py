r"""
=============================================================================
Script Name: Estate_Orchestrator_v12.py
File Path: C:\Users\donca\Desktop\Desktop HP Envy x360 al 22Abr24\Docs Manuel\IBKR_Options\Estate_Orchestrator_v12.py
Purpose: The Zero-Touch Automation Engine for the Family Office.
         v12 UPGRADES:
         - Added Flex Query parser for "Realized and Unrealized Performance Summary in Base".
         - Auto-extracts Capital Velocity (Win Rate & Avg Days) directly from Options Journal.
         - Continues the "26 Trillion %" Ghost Buster fixes and Margin Automator from v12.
...
def parse_ibkr_universal(csv_text):
    ...
    for line in lines:
        ...
        # v60 Patch: Fuzzy catch for PnL section name
...
def process_ibkr_data(sections):
    ...
    if pnl_df is not None:
        ...
        total_pnl_col = get_col(pnl_df,['Total', 'TotalMTM', 'RealizedTotal', 'Total Realized and Unrealized P/L', 'TotalRealizedAndUnrealizedPnL']) 
...
if __name__ == "__main__":
    print("========================================================")
    print("     ESTATE ORCHESTRATOR v12 - INITIALIZING SYNC...      ")
    print("========================================================")
    ...
    os.system('python Generate_Estate_Dashboard_v60.py')
    
    html_path = os.path.join(TARGET_DIR, "Family_Estate_Dashboard_v60.html")
