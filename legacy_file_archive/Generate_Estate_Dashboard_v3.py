r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v3.py
Purpose: Generates a standalone, interactive HTML dashboard for the Family 
         Estate. 
         VERSION 3: 
         - Added 'Capital Deployment per Silo ($ / %)' dynamic labels.
         - Renamed 'CIO Grading', added 'CIO Min Alloc. %'.
         - Added 'USD Cash' to the master matrix.
         - Added 'Sharpe / Vol Impact' column for deep portfolio insights.
Author: Chief Investment Officer AI Advisor
Date: April 2026

How to Run:
1. Ensure Python is installed on your PC.
2. Save this script as 'Generate_Estate_Dashboard_v3.py'.
3. Run it via terminal or your Python IDE:
   python Generate_Estate_Dashboard_v3.py
4. Navigate to your folder and open 'Family_Estate_Dashboard_v3.html'.
...
file_name = "Family_Estate_Dashboard_v3.html"
...
<head>
    ...
    <title>Family Estate Master Allocator v3</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[1800px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Instrument Matrix v3</p>
        </div>
    ...
    <script>
        ...
        const instruments =[
            ...
            { inst: "XSP Put Credit Spreads", type: "Index Option", risk: "Moderate (Tail Risk)", alpha: "High (VRP)", sharpe: "High (Smooths equity curve)", strat: "Weekly Income (45 DTE)", jur: "US (Cboe)", min: "0%", max: "20%", rec: "Splendid", class: "splendid", 
              comm: "<strong>Cash-settled S&P 500 index options used to collect market fear premium.</strong><br>1,000% safe from IRS. Capped risk. The 20% limit ensures a Black Swan only causes a highly manageable ~10% portfolio drawdown." },
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v3 created.")
