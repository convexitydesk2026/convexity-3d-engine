"""
=============================================================================
Script Name: sync_engine_v38.py
...
def sync_tws():
    print("========================================================")
    print("   ESTATE SYNC ENGINE v38 - DYNAMIC SILO DISCOVERY")
    print("========================================================")    
    ...
    for i, acc in enumerate(accounts):
        if acc not in config['SILOS']:
            ...
            config_changed = True
            print(f"    -> Discovered new account: {acc}. Injected into config.")
