...
3. Launch the UI by running exactly:
   streamlit run dashboard_v53.py

CHANGELOG (v53):
         - REMOVED: Manual Alpha Log Entry Form (Replaced by Flex Query API Engine).
         - FIXED: Synthetic Beta Categorization.
=============================================================================
"""
