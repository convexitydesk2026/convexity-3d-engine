...
3. Launch the UI by running exactly:
   streamlit run dashboard_v36.py
...
with c_action:
    if distance_usd <= 1000:
        ...
        # --- CEILING GOVERNOR LOGIC (v36 Proportional Overflow) ---
...
if not journal_raw_df.empty:
    ...
    if selected_rows.empty:
        ...
        if str(raw_dte) == 'Closed':
            ...
            # Dynamically invert the plot boundaries depending on the danger zone
            if is_call:
            ...
            with col_2d:
                # --- NEW v36: LIVE TWS P&L EXTRACTION ---
                ...
                # Invert Green (Profit) and Red (Loss) zones dynamically
                if is_call:
            ...
            with col_3d:
                ...
                # --- v36 ENHANCEMENT: Intersection Curves (Wireframing the Kill Box) ---
                z_green, z_red = [], []
                for d in y_3d:
                ...
                # --- Exact Z=0 (Gray) Interpolation Curve ---
                ...
                fig_3d.add_trace(go.Surface(
                    ...
                    colorscale=[[0, 'green'],[1, 'green']], opacity=0.225, showscale=False, hoverinfo='skip'
                ))
                fig_3d.add_trace(go.Surface(
                    x=[[K_l, K_l],[K_l, K_l]], y=[[0, init_dte],[0, init_dte]], z=[[z_min, z_min],[z_max, z_max]],
                    colorscale=[[0, 'red'],[1, 'red']], opacity=0.225, showscale=False, hoverinfo='skip'
                ))
                fig_3d.add_trace(go.Surface(
