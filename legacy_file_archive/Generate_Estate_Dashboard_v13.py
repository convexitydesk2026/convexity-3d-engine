r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v13.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 13 UPGRADES: 
         - Master 'Estate' Global Aggregation Panel
         - Advanced Metrics: ROC% (using Max Capital Employed), Calmar Ratio, DD Days.
         - Fix: Options Liability completely vanishes from UI when set to 0.
         - Fix: Auto-injects dynamic NAV into the HTML inputs.
         - Added: BTC/ETH UCITS, TQQQ, XND, XSP LEAPS to Instrument Matrix.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v13.html")
...
metrics = {
    ...
    "U23144948": {"irr": "--", "sharpe": "--", "pnl": "--", "maxdd": "--", "dd_days": "--", "calmar": "--", "roc": "--", "nav": 604056},
    "U23139264": {"irr": "--", "sharpe": "--", "pnl": "--", "maxdd": "--", "dd_days": "--", "calmar": "--", "roc": "--", "nav": 29158},
    "U23154199": {"irr": "--", "sharpe": "--", "pnl": "--", "maxdd": "--", "dd_days": "--", "calmar": "--", "roc": "--", "nav": 292557},
    "U25218481": {"irr": "--", "sharpe": "--", "pnl": "--", "maxdd": "--", "dd_days": "--", "calmar": "--", "roc": "--", "nav": 1.01}
}
...
if os.path.exists(csv_file_path):
    try:
        ...
        # Pivot to ensure all days are aligned and forward-filled for accurate summation
...
<head>
    ...
    <title>Family Estate Master Allocator v13</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[1800px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v13</p>
        </div>
        ...
        <div class="bg-gray-100 p-4 rounded-xl shadow-md text-center border border-gray-300 mb-6">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 text-sm mt-3 border-t border-gray-300 pt-3 font-mono">
                ...
                <div>DD Duration<br><span class="text-gray-600 font-black text-lg">VAR_ESTATE_DD_DAYS days</span></div>
        ...
        <div class="mb-8 grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="bg-blue-900 text-white p-4 rounded-xl shadow-md text-center border-b-4 border-blue-500 relative">
                ...
                <div class="grid grid-cols-2 text-xs mt-3 border-t border-blue-700 pt-3 gap-y-2 font-mono">
                    ...
                    <div class="text-center col-span-2 bg-blue-950 py-1 rounded">ROC%: <span class="VAR_COLOR_A_ROC font-bold">VAR_A_ROC</span></div>
                </div>
            </div>
            ...
            <div class="bg-purple-900 text-white p-4 rounded-xl shadow-md text-center border-b-4 border-purple-500">
                ...
                <div class="grid grid-cols-2 text-xs mt-3 border-t border-purple-700 pt-3 gap-y-2 font-mono">
                    ...
                    <div class="text-center col-span-2 bg-purple-950 py-1 rounded">ROC%: <span class="VAR_COLOR_B_ROC font-bold">VAR_B_ROC</span></div>
                </div>
            </div>
            ...
            <div class="bg-green-900 text-white p-4 rounded-xl shadow-md text-center border-b-4 border-green-500">
                ...
                <div class="grid grid-cols-2 text-xs mt-3 border-t border-green-700 pt-3 gap-y-2 font-mono">
                    ...
                    <div class="text-center col-span-2 bg-green-950 py-1 rounded">ROC%: <span class="VAR_COLOR_C_ROC font-bold">VAR_C_ROC</span></div>
                </div>
            </div>
            ...
            <div class="bg-yellow-100 text-gray-900 p-4 rounded-xl shadow-md text-center border-b-4 border-yellow-400">
                ...
                <div class="grid grid-cols-2 text-xs mt-3 border-t border-yellow-300 pt-3 gap-y-2 font-mono">
                    ...
                    <div class="text-center col-span-2 bg-yellow-200 py-1 rounded">ROC%: <span class="VAR_COLOR_D_ROC font-bold">VAR_D_ROC</span></div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-8 bg-gray-50 p-4 rounded-xl border shadow-sm">
            ...
            <p class="text-sm text-gray-500 mb-4 border-b pb-2">Fields auto-populated from IBKR data feed. Adjust manually below for simulations.</p>
    ...
    <script>
        ...
        function updateUI() {
            ...
            // SMART BAR CHART LOGIC (Hides traces entirely if 0)
            let barData = [
            ...
            let barLayout = { 
                barmode: 'relative', title: 'GAAP Balance Sheet per Silo ($ / %)', 
            ...
            // SMART PIE CHART LOGIC (Build array dynamically)
            let rawPieData =[
...
for acc, prefix in[("ESTATE", "ESTATE"), ("U23144948", "A"), ("U23139264", "B"), ("U23154199", "C"), ("U25218481", "D")]:
    ...
    # Auto-populate NAV inputs (Silos A, B, C, D only)
    if prefix != "ESTATE":
        html_content = html_content.replace(f"VAR_NAV_{prefix}", str(round(metrics[acc]["nav"], 2)))
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v13 created.")
