r"""
=============================================================================
Script Name: Estate_Orchestrator_v5.py
File Path: C:\Users\donca\Desktop\Desktop HP Envy x360 al 22Abr24\Docs Manuel\IBKR_Options\Estate_Orchestrator_v5.py
Purpose: The Zero-Touch Automation Engine for the Family Office.
         V5 UPGRADES:
         - Engineered 'SPY_Technical_Proof.csv' generation. Exports a daily 
           verifiable ledger of Open, Close, 10, 20, 50, and 200 SMAs.
         - Preserved secure config.ini loading and IBKR resilient parsing.
...
def update_yfinance_data():
    ...
    try:
        ...
        # v5 CHANGE: Engineered the SPY Technical Proof CSV Generation
        ...
        # Clean up the proof DataFrame and format dates
        ...
        # --- Continuing with standard Benchmarks & Regime logic ---
        if 'Close' in data.columns:
            close_data = data['Close'].ffill() # Forward fill to prevent NaNs
        else:
...
if __name__ == "__main__":
    print("========================================================")
    print("     ESTATE ORCHESTRATOR v5 - INITIALIZING SYNC...      ")
    print("========================================================")
