"""
=============================================================================
Script Name: sync_engine_v31.py
Purpose: Phase 8 of the Local-First Estate Architecture.
         - RESTORED: BASE currency NetLiquidation logic (Fixes missing foreign assets).
         - MAINTAINED: Zero-Balance Failsafe.
=============================================================================
"""
...
def sync_tws():
    print("========================================================")
    print("   ESTATE SYNC ENGINE v31 - FOREIGN ASSET FIX")
    print("========================================================")    
    ...
    for trade in open_trades:
        ...
        if contract.secType == 'BAG':
            for leg in contract.comboLegs:
                ...
                if order.action == 'SELL': leg_action = 'BUY' if leg.action == 'SELL' else 'SELL'
    ...
    for acc in accounts:        
        ...
        # RESTORED: Base Currency tracking
        ...
        if net_liq_final < 100.0:
            print(f"[!] FAILSAFE TRIGGERED: {acc} returned ${net_liq_final}. Likely API timeout. Skipping DB insert to prevent false drawdowns.")
            if ib.isConnected(): ib.disconnect()
            continue
                
        cursor.execute("INSERT INTO daily_balances VALUES (?, ?, ?, ?, ?, ?)", (today_str, acc, 'USD', net_liq_final, 0.0, avail_funds_final))
