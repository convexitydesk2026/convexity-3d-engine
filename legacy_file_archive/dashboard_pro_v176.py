"""
=============================================================================
Script Name: dashboard_pro_v176.py
...
streamlit run dashboard_pro_v176.py
CHANGELOG (v176 PRO):
- STAGE 84 (v176 PRO): Added dynamic vertical red dotted line to Gantt chart to track 'Today'.
- STAGE 83 (v175 PRO): Added Progress % text overlay to Gantt bars. Forced chronological sorting on the Task Ledger table.
- STAGE 82 (v174 PRO): Added Progress % to PM Module. Fixed Gantt fonts, darkened Pending colors, and removed orphan text.
...
if not edited_tasks.empty:
    ...
    fig_gantt.add_vline(x=today_str, line_dash="dot", line_color="red", line_width=2, annotation_text="Today", annotation_position="top right", annotation_font_color="red")
