...
3. Launch the UI by running exactly:
   streamlit run dashboard_v88.py
...
def process_metrics(df_acc, rf_rate):
    ...
    # v88 Absolute Truth Math: Start NAV is inherently 0
...
def load_and_process_data():
    ...
    try:
        ...
        # v88 FIX: Robust NAV Forward Fill (Solves the Phantom Volatility Jump)
    ...
    # Global tracking arrays (v88: Pure Absolute Math across all Silos. Kills the Whipsaw)
