"""
=============================================================================
Script Name: Telegram_Notifier_v30.py
Purpose: Headless Streamlit rendering and Telegram transmission.
         - UPDATED: v30 - Pointed subprocess to dashboard_v171.py
...
def snap_and_send():
    ...
    streamlit_process = subprocess.Popen(["streamlit", "run", "dashboard_v171.py", "--server.port", "8599", "--server.headless", "true"], cwd=TARGET_DIR, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL)
    time.sleep(12)
