r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v40.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 40 UPGRADES:
         - Structural Pivot: Silo A acts as Central Bank.
         - Added descriptive Headers and Footers to Target Composition.
         - Silo B: Removed all ETFs. Restricted to Cash, CFDs, and Intl.
         - Silo D: Replaced % sliders with 10 explicit Ticker/Value inputs for 
           13F/Smart Money tracking. Added auto-calculating NAV override.
         - Mapped Silo D absolute values to Matrix "US Tech CFDs" allocation.
         - EVERY MODIFICATION IS TAGGED WITH 'v40 CHANGE' FOR AUDIT.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v40.html") # v40 CHANGE: Updated filename to v40
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v40)            ") # v40 CHANGE: Updated print statement
print("========================================================")
...
<head>
    ...
    <title>Estate Master Dashboard v40</title> <!-- v40 CHANGE: Title updated -->
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v40</p> <!-- v40 CHANGE: Subtitle updated -->
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-gray-50 p-4 rounded-xl border shadow-sm flex-grow">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <!-- v40 CHANGE: Silo D input is now readonly because it auto-calculates from the 10 ticker values in panel 2 -->
                        <div><label class="block text-sm font-bold text-gray-700">Silo D (USD - Auto)</label><input type="number" id="siloD" value="VAR_NAV_D" class="mt-1 w-full rounded-md p-2 border bg-gray-200 cursor-not-allowed" readonly></div>
                    </div>
                </div>
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-white p-4 rounded-xl border shadow-sm flex-grow">
                    <h3 class="text-xl font-bold mb-2 text-gray-800">2. Target Portfolio Composition</h3> <!-- v40 CHANGE: Removed (%) from title -->
                    <p class="text-sm text-gray-500 mb-4 border-b pb-2">Physical assets must mathematically equal 100%.</p>
                    
                    <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                        
                        <!-- Silo A -->
                        <!-- v40 CHANGE: Added Flex col and justify-between for sticky footer -->
                        <div class="bg-blue-50 p-4 rounded-lg border border-blue-400 shadow-inner flex flex-col justify-between">
                            <div>
                                <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-blue-400 pb-1">Silo A (The Central Bank)</h4> <!-- v40 CHANGE: Added Header Name -->
                        ...
                        <div class="bg-purple-50 p-4 rounded-lg border border-purple-400 shadow-inner flex flex-col justify-between">
                            <div>
                                <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-purple-400 pb-1">Silo B (The Momentum Sandbox)</h4> <!-- v40 CHANGE: Added Header Name -->
                                <p class="text-[10px] font-bold text-gray-800 mb-1 uppercase tracking-wide">Physical Balance Sheet</p>
                                
                                <!-- v40 CHANGE: Purged ETF sliders. Only Cash, CFDs, and Intl remain per instructions -->
                                <label class="text-[10px] font-bold text-gray-900" id="b_cash_label">Cash: </label><input type="range" id="b_cash" min="-50" max="100" step="0.01" value="100.0" class="w-full mb-2" oninput="updateUI()">
                        ...
                        <div class="bg-green-50 p-4 rounded-lg border border-green-400 shadow-inner flex flex-col justify-between">
                            <div>
                                <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-green-400 pb-1">Silo C (The Options Engine)</h4> <!-- v40 CHANGE: Added Header Name -->
                                <p class="text-[10px] font-bold text-gray-800 mb-1 uppercase tracking-wide">Physical Balance Sheet</p>
                        ...
                        <div class="bg-yellow-50 p-4 rounded-lg border border-yellow-400 shadow-inner flex flex-col justify-between">
                            <div>
                                <h4 class="font-black text-gray-900 mb-2 text-sm border-b border-yellow-400 pb-1">Silo D (The Smart Money Sandbox)</h4> <!-- v40 CHANGE: Added Header Name -->
                                <p class="text-[10px] font-bold text-gray-800 mb-2 uppercase tracking-wide">13F / Smart Money Holdings</p>
                                
                                <!-- v40 CHANGE: Replaced % sliders with 10 explicit Ticker/Value inputs -->
                                <div class="flex gap-2 mb-1"><input type="text" placeholder="Ticker 1" class="w-1/3 text-[10px] p-1 border border-gray-300 rounded"><input type="number" id="d_val_1" placeholder="$ Value" value="0" class="w-2/3 text-[10px] p-1 border border-gray-300 rounded" oninput="updateUI()"></div>
                                <div class="flex gap-2 mb-1"><input type="text" placeholder="Ticker 2" class="w-1/3 text-[10px] p-1 border border-gray-300 rounded"><input type="number" id="d_val_2" placeholder="$ Value" value="0" class="w-2/3 text-[10px] p-1 border border-gray-300 rounded" oninput="updateUI()"></div>
                                <div class="flex gap-2 mb-1"><input type="text" placeholder="Ticker 3" class="w-1/3 text-[10px] p-1 border border-gray-300 rounded"><input type="number" id="d_val_3" placeholder="$ Value" value="0" class="w-2/3 text-[10px] p-1 border border-gray-300 rounded" oninput="updateUI()"></div>
                                <div class="flex gap-2 mb-1"><input type="text" placeholder="Ticker 4" class="w-1/3 text-[10px] p-1 border border-gray-300 rounded"><input type="number" id="d_val_4" placeholder="$ Value" value="0" class="w-2/3 text-[10px] p-1 border border-gray-300 rounded" oninput="updateUI()"></div>
                                <div class="flex gap-2 mb-1"><input type="text" placeholder="Ticker 5" class="w-1/3 text-[10px] p-1 border border-gray-300 rounded"><input type="number" id="d_val_5" placeholder="$ Value" value="0" class="w-2/3 text-[10px] p-1 border border-gray-300 rounded" oninput="updateUI()"></div>
                                <div class="flex gap-2 mb-1"><input type="text" placeholder="Ticker 6" class="w-1/3 text-[10px] p-1 border border-gray-300 rounded"><input type="number" id="d_val_6" placeholder="$ Value" value="0" class="w-2/3 text-[10px] p-1 border border-gray-300 rounded" oninput="updateUI()"></div>
                                <div class="flex gap-2 mb-1"><input type="text" placeholder="Ticker 7" class="w-1/3 text-[10px] p-1 border border-gray-300 rounded"><input type="number" id="d_val_7" placeholder="$ Value" value="0" class="w-2/3 text-[10px] p-1 border border-gray-300 rounded" oninput="updateUI()"></div>
                                <div class="flex gap-2 mb-1"><input type="text" placeholder="Ticker 8" class="w-1/3 text-[10px] p-1 border border-gray-300 rounded"><input type="number" id="d_val_8" placeholder="$ Value" value="0" class="w-2/3 text-[10px] p-1 border border-gray-300 rounded" oninput="updateUI()"></div>
                                <div class="flex gap-2 mb-1"><input type="text" placeholder="Ticker 9" class="w-1/3 text-[10px] p-1 border border-gray-300 rounded"><input type="number" id="d_val_9" placeholder="$ Value" value="0" class="w-2/3 text-[10px] p-1 border border-gray-300 rounded" oninput="updateUI()"></div>
                                <div class="flex gap-2 mb-1"><input type="text" placeholder="Ticker 10" class="w-1/3 text-[10px] p-1 border border-gray-300 rounded"><input type="number" id="d_val_10" placeholder="$ Value" value="0" class="w-2/3 text-[10px] p-1 border border-gray-300 rounded" oninput="updateUI()"></div>
                                
                                <div class="flex gap-2 mb-1 mt-3 border-t border-yellow-300 pt-2">
                                    <span class="w-1/3 text-[10px] font-bold pt-1">Cash Bal:</span>
                                    <input type="number" id="d_val_cash" value="1.01" class="w-2/3 text-[10px] p-1 border border-gray-300 rounded bg-white" oninput="updateUI()">
                                </div>
                            </div>
                            <!-- v40 CHANGE: Added Footer -->
    ...
    <script>
        ...
        const instruments =[
            ...
            { id: "cfd", inst: "US Tech CFDs", type: "OTC Contract", risk: "Aggressive", alpha: "High", sharpe: "Negative", strat: "Swing Trading", jur: "UK/Offshore", tax: "Exempt (OTC Derivative)", min: "0%", max: "3%", rec: "Good", class: "good", comm: "Synthetic derivatives. 0% IRS risk. Quarantined to Silo B & D." },
        ...
        function updateUI() {
            ...
            // v40 CHANGE: Silo D is now dynamically summed from its absolute $ inputs, replacing the manual text field
            let amt_D_cfd = 0;
            for(let i=1; i<=10; i++) {
            ...
            let sD = amt_D_cfd + amt_D_cash;
            document.getElementById('siloD').value = sD.toFixed(2); // Auto-update Panel 1
            ...
            // Silo B (v40 CHANGE: Removed ETFs, parsing only Cash, CFD, Intl)
            ...
            document.getElementById('b_cfd_label').innerText = `US Tech CFDs: ${fmtCur(amt_B_cfd)} (${b_cfd.toFixed(2)}%)`;
            ...
            // Aggregation & Risk Radars (v40 CHANGE: Removed amt_B_ib01, amt_D_ib01 etc. from globals)
            ...
            let tot_cfd = amt_B_cfd + amt_D_cfd; // v40 CHANGE: New aggregate
            let tot_intl = amt_B_intl; // v40 CHANGE: New aggregate

            // Risk Alerts Logic
            let techSemiPct = totalEstate > 0 ? ((tot_cndx + tot_itwn + tot_cskr + tot_cfd) / totalEstate) * 100 : 0; // v40 CHANGE: Updated CFD aggregate
            ...
            // Dynamic Matrix Injection & Total Checksum (v40 CHANGE: Linked tot_cfd and tot_intl properly)
            const allocMap = {
            ...
            // Charts Formatting Logic (v40 CHANGE: Zeroed out removed silos variables)
            ...
            // v40 CHANGE: Updated Pie Chart Variables
            let rawPieData =[
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v40 created.")
