    ...
    if selected_rows.empty:
        ...
        if str(raw_dte) == 'Closed':
            ...
            with col_2d:
                ...
                # Didactic Zones (Max Profit / Max Loss Areas)
            ...
            with col_3d:
                ...
                # --- NEW: DIDACTIC 3D PLANES ---
                
                # A. Short Strike & Long Strike walls (Green & Red)
                ...
                # B. 50% DTE Trap (Vertical Yellow Plane)
                ...
                # C. Breakeven Line (Horizontal Gray Plane at Z = 0)
                fig_3d.add_trace(go.Surface(
                    x=[[x_vals[0], x_vals[-1]],[x_vals[0], x_vals[-1]]],
                ...
                # 4. 3D Lines for Entry Day and Today
                ...
                # 5. Plot Current Market Price Dot
                fig_3d.add_trace(go.Scatter3d(
