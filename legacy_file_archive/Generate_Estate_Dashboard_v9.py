r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v9.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 9: 
         - Slider resolution upgraded to 0.01%.
         - Added 'Options Mkt Val (Liability)' to Silos A & C to allow 
           GAAP-compliant Mark-to-Market accounting (allows negative % to 
           balance Cash + IB01 > 100%).
         - Python Data Engine upgraded to calculate 'Total P&L ($)' and 
           'Max Drawdown' from the CSV history.
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v9.html")
...
def process_account_metrics(df, account_id):
    ...
    # --- Max Drawdown ---
    df_acc['Peak'] = df_acc['NAV'].cummax()
    df_acc['Drawdown'] = (df_acc['NAV'] - df_acc['Peak']) / df_acc['Peak'].replace(0, np.nan)
...
<head>
    ...
    <title>Family Estate Master Allocator v9</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[1800px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v9 (Mark-to-Market)</p>
        </div>
        ...
        <div class="mb-8 grid grid-cols-1 md:grid-cols-4 gap-4">
            <div class="bg-blue-900 text-white p-4 rounded-xl shadow-md text-center border-b-4 border-blue-500">
                ...
                <p class="text-xs mb-1 text-gray-400">U23144948</p>
            ...
            <div class="bg-purple-900 text-white p-4 rounded-xl shadow-md text-center border-b-4 border-purple-500">
                ...
                <p class="text-xs mb-1 text-gray-400">U23139264</p>
            ...
            <div class="bg-green-900 text-white p-4 rounded-xl shadow-md text-center border-b-4 border-green-500">
                ...
                <p class="text-xs mb-1 text-gray-400">U23154199</p>
            ...
            <div class="bg-yellow-theme text-white p-4 rounded-xl shadow-md text-center border-b-4 border-yellow-theme">
                ...
                <p class="text-xs mb-1 text-gray-400">U25218481</p>
                <div class="grid grid-cols-2 text-sm mt-3 border-t border-yellow-500 pt-3 gap-y-2 font-mono">
                    ...
                    <div class="text-right">Max DD: <span class="text-red-400 font-bold">VAR_D_MAXDD</span></div>
                </div>
            </div>
        </div>
        ...
        <div class="mb-8 bg-white p-4 rounded-xl border shadow-sm">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-yellow-50 p-3 rounded-lg border border-yellow-300 shadow-inner">
                    ...
                    <p class="text-xs font-bold text-gray-500 mb-1 uppercase tracking-wide">Physical Balance Sheet (Must = 100%)</p>
                    <label class="text-xs font-semibold" id="d_ib01_label">IB01: </label><input type="range" id="d_ib01" min="0" max="100" step="0.01" value="40.0" class="w-full mb-1" oninput="updateUI()">
                    <label class="text-xs font-semibold" id="d_cspx_label">CSPX: </label><input type="range" id="d_cspx" min="0" max="100" step="0.01" value="30.0" class="w-full mb-1" oninput="updateUI()">
                    <label class="text-xs font-semibold" id="d_xuse_label">XUSE: </label><input type="range" id="d_xuse" min="0" max="100" step="0.01" value="15.0" class="w-full mb-1" oninput="updateUI()">
                    <label class="text-xs font-semibold" id="d_eimi_label">EIMI: </label><input type="range" id="d_eimi" min="0" max="100" step="0.01" value="5.0" class="w-full mb-1" oninput="updateUI()">
                    <label class="text-xs font-semibold" id="d_cash_label">Cash: </label><input type="range" id="d_cash" min="0" max="100" step="0.01" value="10.0" class="w-full mb-1" oninput="updateUI()">
...
html_content = html_content.replace("VAR_COLOR_D_PNL", get_color_class(metrics["U25218481"]["pnl"]))
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v9 created with Mark-to-Market Accounting.")
