...
3. Launch the UI by running exactly:
   streamlit run dashboard_v80.py

CHANGELOG (v80):
         - MATH FIX: Corrected Silo and Global PnL to strictly calculate (Live NAV - Total Flows).
         - FIX: Decoupled historical attribution from live T-0 PnL to permanently kill chart Whipsaws.
=============================================================================
"""
...
def process_metrics(df_acc, rf_rate):
    ...
    # V80 Absolute Truth Math: Start NAV is inherently 0
...
def load_and_process_data():
    ...
    try:
        ...
        # v80 FIX: Robust NAV Forward Fill (Solves the Phantom Volatility Jump)
    ...
    # Global tracking arrays (V80: Pure Absolute Math across all Silos. Kills the Whipsaw)
