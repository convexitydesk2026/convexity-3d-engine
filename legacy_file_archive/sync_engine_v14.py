"""
=============================================================================
Script Name: sync_engine_v14.py
...
def sync_tws():
    print("========================================================")
    print("   ESTATE SYNC ENGINE v14 - ISOLATED SESSION EXTRACTION")
    print("========================================================")
    ...
    for p in master_positions:
        if p.position != 0: # IGNORING CLOSED POSITIONS!
    ...
    for acc in accounts:
        ...
        print(f"[*] Expected LIVE Positions to Download: {expected}")
        ...
        cursor.execute('''INSERT INTO daily_balances 
                          ...
                          VALUES (?, ?, ?, ?, ?)''', (today_str, acc, 'USD', net_liq, total_cash))
