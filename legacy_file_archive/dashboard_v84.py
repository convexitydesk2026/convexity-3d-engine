...
3. Launch the UI by running exactly:
   streamlit run dashboard_v84.py

CHANGELOG (v84):
         - UI UPGRADE: Added "Back to Top / Alerts" link in the Quick Navigation sidebar.
=============================================================================
"""
...
def process_metrics(df_acc, rf_rate):
    ...
    # v84 Absolute Truth Math: Start NAV is inherently 0
...
def load_and_process_data():
    ...
    try:
        ...
        # v84 FIX: Robust NAV Forward Fill (Solves the Phantom Volatility Jump)
    ...
    # Global tracking arrays (v84: Pure Absolute Math across all Silos. Kills the Whipsaw)
