"""
=============================================================================
Script Name: dashboard_v10.py
Purpose: The Streamlit Frontend (Module 10).
         - Resolves KeyError: 'currency' in Master Matrix by mapping sec_type.
         - Fixes UI Regime Squares to display clean Date/Regime/TOR hover data.
         - Un-truncated: Preserves all 9 panels, metrics, and gauge charts.
=============================================================================
"""
...
# Calculate Current Global Allocations (KeyError patched via sec_type logic)
alloc_map = {}
