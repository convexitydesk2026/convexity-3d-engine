r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v42.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 42 UPGRADES:
         - Fixed Panel 2 Overflow: Removed 'flex-grow' and 'h-full' constraints 
           so the Target Composition boxes stretch naturally without hiding under 
           the PnL chart.
         - Fixed PnL Axis Overlap: Anchored the X-axis dates to the new y3 axis, 
           pushing the dates cleanly below the Regime squares. Increased bottom margin.
         - Fixed TOR Legibility: Python now strips decimals from TOR values. 
           Increased Javascript font size to 16pt Arial Black for the Regime squares.
         - Preserved all v41 features (Scroll Zoom, Smart Money Silo D, Risk Radars).
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v42.html") # v42 CHANGE: Name updated
...
print("\n========================================================")
print("             CIO DIAGNOSTICS & LOGGING (v42)            ") # v42 CHANGE: Updated
print("========================================================")
...
if not bench_df.empty and not global_df.empty:
    ...
    if first_date:
        ...
        # v42 CHANGE: Removed decimals from TOR by casting to float then int
...
<head>
    ...
    <title>Estate Master Dashboard v42</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v42</p>
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <!-- SILO INPUTS -->
                <!-- v42 CHANGE: Removed 'flex-grow' to prevent left column stretching issues -->
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <!-- v42 CHANGE: Removed 'flex-grow' to prevent overflowing into the bottom panel -->
                <div class="bg-white p-4 rounded-xl border shadow-sm">
                    ...
                    <!-- v42 CHANGE: Removed 'h-full' to allow boxes to size naturally -->
    ...
    <script>
        ...
        if (datesPnl && datesPnl.length > 0) {
            ...
            let traceRegime = {
                ...
                insidetextfont: {color: regimeFonts, size: 16, family: 'Arial Black'}, // v42 CHANGE: Increased size to 16
                hoverinfo: 'text',
            ...
            let pnlLayout = {
                barmode: 'relative',
                margin: {t: 20, b: 50, l: 60, r: 60}, // v42 CHANGE: Increased bottom margin from 40 to 50
                paper_bgcolor: 'rgba(0,0,0,0)',
                plot_bgcolor: 'rgba(0,0,0,0)',
                xaxis: { type: 'date', showgrid: false, fixedrange: false, anchor: 'y3' }, // v42 CHANGE: Anchored xaxis to y3 to push dates below squares
                yaxis: { title: 'Daily PnL (USD)', side: 'left', showgrid: true, gridcolor: '#e5e7eb', zeroline: true, zerolinecolor: '#9ca3af', zerolinewidth: 2, fixedrange: true, domain:[0.09, 1] }, // v42 CHANGE: Adjusted domain to 0.09
                yaxis2: { title: 'Cumulative PnL (USD)', side: 'right', overlaying: 'y', showgrid: false, zeroline: false, fixedrange: true, domain: [0.09, 1] }, // v42 CHANGE: Adjusted domain to 0.09
                yaxis3: { domain:[0, 0.06], visible: false, fixedrange: true }, // v42 CHANGE: Increased domain to 0.06 for larger text
                legend: { orientation: 'h', y: 1.1, x: 0.5, xanchor: 'center' }
            };
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v42 (Polished Edition) created.")
