...
# NEW: 9th Alert (Tail Hedge Deployment)
if (regime_str == 'Red' or last_vix < 15.0) and th_available >= 200:
    trigger_reason = "VIX Complacency Crash (< 15)" if last_vix < 15.0 else "Red Regime Panic"
    alerts.append(f"🛡️ **Tail Hedge Deployment Due:** Market signaled {trigger_reason}. You have **${th_available:,.0f}** in available insurance budget. Purchase 90-120 DTE deep OTM S&P 500 Puts.")
