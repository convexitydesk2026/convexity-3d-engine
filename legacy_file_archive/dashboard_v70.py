...
3. Launch the UI by running exactly:
   streamlit run dashboard_v70.py
...
def fetch_live_data(ticker_symbol):
    ...
    # v70: Safeguard against empty cells during live data-entry
...
def get_exact_opt_margin(df_in):
    ...
    try:
        ...
        # v70 FIX: Added base_tckr to the groupby!
...
# v70 FIX: Added Physical US Stocks & International Stocks to Core Assets pool
...
if not journal_raw_df.empty:
    ...
    if not active_vrp.empty:
        ...
        # v70: Dynamically map LIVE TWS PnL to calculate Live Annualized ROC
        live_roc_list = []
        live_ann_roc_list = []
...
if not journal_raw_df.empty:
    ...
    if selected_rows.empty:
        ...
        if str(raw_dte) == 'Closed':
            ...
            # v70: 3D Engine Native Debit Spread & Call Detection
