...
3. Launch the UI by running exactly:
   streamlit run dashboard_v81.py

CHANGELOG (v81):
         - UI UPGRADE: Injected Heads-Up Display (HUD) KPI Banner.
         - OPTIMIZATION: Hoisted Beta-Weighted Delta math for global scope availability.
=============================================================================
"""
...
def process_metrics(df_acc, rf_rate):
    ...
    # v81 Absolute Truth Math: Start NAV is inherently 0
...
def load_and_process_data():
    ...
    try:
        ...
        # v81 FIX: Robust NAV Forward Fill (Solves the Phantom Volatility Jump)
    ...
    # Global tracking arrays (v81: Pure Absolute Math across all Silos. Kills the Whipsaw)
