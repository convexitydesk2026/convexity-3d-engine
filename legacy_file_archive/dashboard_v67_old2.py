...
if not df_phys.empty:
    for sym, g in df_phys.groupby('symbol'):
        ...
        # FIX: avg_cost from IBKR is per-share. Multiply by position to get true total cost.
...
if not df_alpha.empty:
    ...
    for i, r in df_alpha.iterrows():
        # Thick Black Line for Cost Value
        fig_alpha.add_shape(type="line", x0=i-0.4, x1=i+0.4, y0=r['Cost'], y1=r['Cost'], line=dict(color="black", width=3))
    ...
    fig_alpha.update_xaxes(tickmode='array', tickvals=x_pos, ticktext=df_alpha['Ticker'])
