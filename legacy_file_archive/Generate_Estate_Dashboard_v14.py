r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v14.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 14 UPGRADES: 
         - Added 'Untampered Static Balance' to all headers as a reference.
         - Removed all hardcoded NAV fallbacks (Silo D $1.01 now pulls strictly from CSV).
         - Retained accurate IRR and ROC% (Rejected standard ARR due to CF distortion).
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v14.html")
...
# ---------------------------------------------------------
# Default NAVs set to 0. Real values pull strictly from the CSV.
metrics = {
...
<head>
    ...
    <title>Family Estate Master Allocator v14</title>
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[1800px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-6">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v14</p>
        </div>
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v14 created.")
