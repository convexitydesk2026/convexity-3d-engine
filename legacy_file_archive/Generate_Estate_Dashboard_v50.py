r"""
=============================================================================
Script Name: Generate_Estate_Dashboard_v50.py
Purpose: Generates the Interactive Family Estate Dashboard.
         VERSION 46 UPGRADES:
         - Added QQQ Alpha, QQQ Correlation, SPY Sharpe, and QQQ Sharpe.
         - Restructured the Master Aggregation Grid to md:grid-cols-7 (14 items) 
           for perfectly balanced UI alignment.
         - Corrected nested HTML span tags from v45 for cleaner DOM rendering.
         - Preserved all prior features (Regime Ribbon, Smart Money Silo D, 
           Absolute Dollar composition boxes, Cash Drag radars).
...
full_file_path = os.path.join(target_directory, "Family_Estate_Dashboard_v50.html") # v50 CHANGE: Name updated
...
# v50 CHANGE: Load Silo D Automated Data from Orchestrator
silo_d_holdings_js = "[]"
...
if not bench_df.empty and not global_df.empty:
    ...
    if first_date:
        ...
        # v50 CHANGE: Calculate Comprehensive Benchmark Metrics (Alpha, Corr, Sharpe for SPY & QQQ)
...
<head>
    ...
    <title>Estate Master Dashboard v50</title> <!-- v50 CHANGE -->
...
<body class="bg-slate-50 text-gray-800 font-sans p-4 md:p-6">
    ...
    <div class="max-w-[98%] 2xl:max-w-[2400px] mx-auto bg-white rounded-xl shadow-xl p-6 border border-gray-200">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-gray-500 mt-2 font-medium">Silo Allocation & Institutional Data Engine v50</p> <!-- v50 CHANGE -->
        </div>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-8">
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-gray-100 p-4 rounded-xl shadow-md border border-gray-300 relative">
                    ...
                    <!-- v50 CHANGE: Expanded grid to md:grid-cols-7 (14 items total) to neatly fit SPY/QQQ Sharpes, Alphas, and Corrs -->
            ...
            <div class="xl:col-span-6 flex flex-col gap-6">
                ...
                <div class="bg-white p-4 rounded-xl border shadow-sm">
                    ...
                    <!-- v50 CHANGE: Silo Strategy & Execution Guidelines -->
    ...
    <script>
        ...
        function updateUI() {
            ...
            // v50 CHANGE: Calculate True Net Checksum by explicitly showing the Liability Drag
            ...
            // The alarm now triggers off the TRUE NET checksum, not the gross physical assets
        ...
        // v50 CHANGE: Auto-Fill Silo D Smart Money Boxes from JSON
...
# v50 CHANGE: Calculate Alpha, Correlation, and Benchmark Sharpes
spy_alpha_str = "N/A"
spy_corr_str = "N/A"
qqq_alpha_str = "N/A"
qqq_corr_str = "N/A"
...
# v50 CHANGE: Inject into HTML using exact variable mapping
...
try:
    ...
    print("====================================================================")
    print(f"SUCCESS! Estate Dashboard v50 created.")
