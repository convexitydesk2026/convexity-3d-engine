...
Launch the UI by running exactly: streamlit run market_flow_engine_v8.py             
Author:      Virtual CFO
Date:        July 2026
Version:     8.0 (Integrated estate_env.py for dynamic OS-agnostic pathing)
================================================================================
"""
