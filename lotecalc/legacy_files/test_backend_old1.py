...
def run_full_backend_test():
    ...
    print("\n3. Simulating User Inputs (Width: 20m, Depth: 40m, Price: $1,500,000)...")
    validation = validate_lot_inputs(width="15", depth="40", asking_price_str="500,000")
    ...
    print("\n4. Running Financial Math Engine...")
