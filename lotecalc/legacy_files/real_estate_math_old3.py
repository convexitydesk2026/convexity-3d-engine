...
VERSION: 1.3 (Permuta Percentage Logic)
DATE: August 03, 2026
...
class FeasibilityEngine:
    def __init__(self, width, depth, zoning_data, project_type, finish_quality, asking_price=None, permuta_pct=0):
    ...
    def run_feasibility(self):
        ...
        if self.asking_price:
            # Calculate Permuta Dollar Amount dynamically
