...
FILE: app.py
VERSION: 1.1 (Fixed Component Deprecation & Session State)
DATE: August 03, 2026
...
if st.button(t["btn_calculate"]):
    if not sector_id:
        ...
        if not val["is_valid"]:
            ...
            # 3. Run Engine
            engine = FeasibilityEngine(w, d, zoning_data, project_type_input, finish_input, price, permuta)
