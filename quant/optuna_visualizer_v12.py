# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_visualizer_v12.py
# Version: 12.0
# Description:
#   Visualizer adapted to the V12 Optuna Hyperparameter Space (Max Positions, 
#   ATR Padding, and Risk %).
# ==============================================================================
...
# Import from the v12 engine script
from optuna_swing_engine_v12 import VectorizedSwingEngine, PROJECT_DIR
...
def visualize_champion_run():
    ...
    subtitle = f"Entry: {p_entry}m | Target: {p_target}x | R-Mult: {p_r_mult} | SMA: {p_sma} | Max Pos: {p_max_positions} | ATR Pad: {p_atr_pad} | Risk: {p_risk_pct}"
