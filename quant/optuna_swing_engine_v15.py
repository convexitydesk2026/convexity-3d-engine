# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_swing_engine_v15.py
# Version: 15.0
# Description:
#   Vectorized Swing Trading Optuna Engine (7.5x ATR Core).
#   v15 hard-locks the 200-Day SPY Regime filter as a fixed parameter based on 
#   visual confirmation, reducing Optuna's search space for faster convergence.
# ==============================================================================
...
class VectorizedSwingEngine:
    ...
    def objective(self, trial):
        ...
        for date in self.trading_dates:
            ...
            # V15 Macro Regime Filter Check using FIXED parameter
