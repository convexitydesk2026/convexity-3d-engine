# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_swing_engine_v3.py
# Version: 3.0
# Description:
#   Vectorized Swing Trading Optuna Engine (7.5x ATR Core).
#   v3 integrates the ultra-fast Materialized View (daily_ohlc_cache) to prevent
#   database hanging. Uses dual-timeframe resolution for optimal RAM usage.
# ==============================================================================
...
class VectorizedSwingEngine:
    ...
    def load_data(self):
        ...
        # v3 Fix: Using the permanent daily_ohlc_cache to prevent DB hanging
        query_daily = f"""
        SELECT 
            trading_date, symbol,
