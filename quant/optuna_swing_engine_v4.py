# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_swing_engine_v4.py
# Version: 4.0
# Description:
#   Vectorized Swing Trading Optuna Engine (7.5x ATR Core).
#   v4 introduces the "Top 40 Candidates" memory optimization. By restricting the 
#   1-minute bar fetch to only the highest-momentum setups each day, we reduce 
#   the RAM payload by 90% and eliminate disk thrashing, allowing instant startup.
# ==============================================================================
...
class VectorizedSwingEngine:
    ...
    def load_data(self):
        ...
        # --- V4 MEMORY OPTIMIZATION: Keep only Top 40 candidates per day ---
