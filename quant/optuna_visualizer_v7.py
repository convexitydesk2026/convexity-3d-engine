# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_visualizer_v7.py
# Version: 7.0
# Description:
#   Visualizer for the 7.5x ATR Swing Engine. 
#   v7 Fixes the strict float-to-int string formatting crash during trade logging.
# ==============================================================================
...
# Import from the v6 engine script
from optuna_swing_engine_v6 import VectorizedSwingEngine, PROJECT_DIR
            ...
            for sym, row in candidates.iterrows():
                ...
                for i in range(idx+1, len(bars)):
                    if bars[i, 3] <= lod:
                        ...
                        # V7 Fix: Explicit int() cast on the numpy array float
