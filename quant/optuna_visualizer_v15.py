# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_visualizer_v15.py
# Version: 15.0
# Description: Visualizer matching the V15 Fixed 200-SMA Regime Filter.
# ==============================================================================
...
from optuna_swing_engine_v15 import VectorizedSwingEngine, PROJECT_DIR
...
def visualize_champion_run():
    ...
    p_atr_pad = float(best_params['atr_padding'])
    ...
    for date in engine.trading_dates:
        ...
        for row in candidates:
            ...
            min_stop_distance = row['atr_14_prev'] * p_atr_pad
            ...
            if not day1_exit:
                open_positions[sym] = {
                    ...
                    'initial_stop': lod, 
                    'active_stop': max(entry_px, row[p_sma]) if day1_target_hit else lod, 
                    'target_price': target, 
    ...
    subtitle = f"Entry: {p_entry}m | Target: {p_target}x | R-Mult: {p_r_mult} | SMA: {p_sma} | Max Pos: {p_max_positions} | ATR Pad: {p_atr_pad} | Risk: {p_risk_pct} | Regime: {engine.use_regime_filter} (200 SMA)"
