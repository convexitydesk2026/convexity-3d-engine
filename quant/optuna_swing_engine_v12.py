# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_swing_engine_v12.py
# Version: 12.0
# Description:
#   Vectorized Swing Trading Optuna Engine (7.5x ATR Core).
#   v12: Moves Max Positions, Risk %, and ATR Padding into the dynamic Optuna 
#   Hyperparameter space for maximum strategic exploration.
# ==============================================================================
...
class VectorizedSwingEngine:
    ...
    def objective(self, trial):
        ...
        p_atr_pad = float(params['atr_padding'])
        ...
        for date in self.trading_dates:
            ...
            for row in candidates:
                ...
                # V12: Dynamic Optuna ATR padding
                ...
                if not day1_exit:
                    open_positions[sym] = {
                        'shares': shares, 'entry_price': entry_px, 'initial_stop': lod, 
