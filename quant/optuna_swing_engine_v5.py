# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_swing_engine_v5.py
# Version: 5.0
# Description:
#   Vectorized Swing Trading Optuna Engine (7.5x ATR Core).
#   v5 fixes a SQLAlchemy 2.0+ syntax deprecation for executing raw SQL drops.
# ==============================================================================
...
import pandas as pd
import numpy as np
from sqlalchemy import create_engine, text  # Added 'text' import here
import datetime
import logging
...
class VectorizedSwingEngine:
    ...
    def load_data(self):
        ...
        # --- FIXED IN V5: Replaced pd.io.sql.text with sqlalchemy text() ---
        ...
        for date in self.trading_dates:
            ...
            if date in self.daily_data.index.get_level_values(0):
                ...
                for sym, row in candidates.iterrows():
                    ...
                    if risk_per_share <= 0: continue # Safegaurd against DivisionByZero
