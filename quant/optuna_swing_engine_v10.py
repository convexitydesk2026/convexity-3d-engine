# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_swing_engine_v10.py
# Version: 10.0
# Description:
#   Vectorized Swing Trading Optuna Engine (7.5x ATR Core).
#   v10 Fixes the "Black Hole" Cash Leak: Adds 'if sym in open_positions: continue'
#   to prevent overwriting dictionary keys and evaporating portfolio cash.
# ==============================================================================
    ...
    def objective(self, trial):
        ...
        for date in self.trading_dates:
            ...
            for row in candidates:
                ...
                # V10 FIX: THE ANTI BLACK-HOLE CHECK! Do not buy if we already own it.
                ...
                if not day1_exit:
                    # V10 FIX: Properly assign trailing stop if target was hit on Day 1
                    open_positions[sym] = {
                        'shares': shares, 'initial_stop': lod, 
