# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_swing_engine_v11.py
# Version: 11.0
# Description:
#   Vectorized Swing Trading Optuna Engine (7.5x ATR Core).
#   v11 Fixes Trade Management Logic:
#   - Upgrades Minimum Stop padding from a fixed 0.5% to a dynamic 0.5 * ATR.
#   - Implements "Breakeven Ratchet": Stop moves to Entry Price once target is hit.
# ==============================================================================
    ...
    def objective(self, trial):
        ...
        for date in self.trading_dates:
            ...
            for row in candidates:
                ...
                # V11 Fix: ATR-Based Stop Padding (Minimum stop is 50% of 14-day ATR)
                min_stop_distance = row['atr_14_prev'] * 0.5
