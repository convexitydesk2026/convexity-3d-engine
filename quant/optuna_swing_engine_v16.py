# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_swing_engine_v16.py
# Version: 16.0
# Description:
#   Vectorized Swing Trading Optuna Engine.
#   v16 completely removes the intraday LOD micro-stop and replaces it with a 
#   Pure ATR Multiplier stop to survive morning volatility shakeouts.
# ==============================================================================
...
log_file = os.path.join(LOG_DIR, f"optuna_run_v16_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.log")
...
class VectorizedSwingEngine:
    ...
    def load_data(self):
        ...
        if not df_spy.empty:
            ...
            logging.warning("SPY not found in daily_ohlc_cache! Regime filter will default to TRUE.")
    ...
    def objective(self, trial):
        ...
        p_atr_stop_mult = float(params['atr_stop_multiplier']) # V16 Update
        ...
        for date in self.trading_dates:
            ...
            for row in candidates:
                ...
                # V16 CORE CHANGE: Pure ATR Stop calculation decoupling from Intraday LOD
