# ==============================================================================
# File: C:/Users/donca/Desktop/Desktop HP Envy x360 al 22Abr24/Docs Manuel/IBKR_Options/quant/optuna_visualizer_v8.py
# Version: 8.0
# Description:
#   Visualizer mapped identically to the strict safety mechanics of V8 Engine.
# ==============================================================================
...
from optuna_swing_engine_v8 import VectorizedSwingEngine, PROJECT_DIR
    ...
    for date in engine.trading_dates:
        ...
        for sym, pos in open_positions.items():
            if (date, sym) in engine.daily_data.index:
                bod_nav += pos['shares'] * engine.daily_data.at[(date, sym), 'd_close_prev']
        ...
        for sym, pos in open_positions.items():
            ...
            d_O = engine.daily_data.at[(date, sym), 'd_open']
            d_H = engine.daily_data.at[(date, sym), 'd_high']
            d_L = engine.daily_data.at[(date, sym), 'd_low']
            sma_val = engine.daily_data.at[(date, sym), p_sma]
